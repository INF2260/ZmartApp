...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("193.157.212.89"), 12124)}, "/Users/Aleksander/Documents/Programmering/FUSE/ZmartApp/Zmart.unoproj", GetBundle, new string[] { })
{
