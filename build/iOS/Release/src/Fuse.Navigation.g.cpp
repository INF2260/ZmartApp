...
// /usr/local/share/uno/Packages/Fuse.Navigation/0.39.3/$.uno
// ----------------------------------------------------------
...
static void BackForwardNavigationTriggerAction_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/0.39.3/$.uno");
...
void EdgeNavigation__OnRooted_fn(EdgeNavigation* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[5/*"Element"*/], __this->Parent(), __this, ::STRINGS[1/*"/usr/local/...*/], 351, ::STRINGS[6/*"OnRooted"*/]);
...
void NavigateToggle__Perform1_fn(NavigateToggle* __this, uObject* ctx, ::g::Fuse::Node* n)
{
    ...
    if (page != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"No Page was...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 3740, ::STRINGS[2/*"Perform"*/]);
}
...
uObject* Navigation::TryFindBaseNavigation1(::g::Fuse::Node* node, ::g::Fuse::Visual** parent)
{
    ...
    *parent = NULL;
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"TryFindBase...*/], node, ::STRINGS[1/*"/usr/local/...*/], 1157, ::STRINGS[12/*"TryFindBase...*/]);
        return NULL;
    }
...
::g::Fuse::Visual* Navigation::TryFindPage(::g::Fuse::Node* node, uObject** nav, ::g::Fuse::Visual** pageBind)
{
    ...
    *pageBind = NULL;
    ...
    if (!uPtr(node)->IsRootingStarted())
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[13/*"TryFindPage...*/], node, ::STRINGS[1/*"/usr/local/...*/], 1218, ::STRINGS[14/*"TryFindPage"*/]);
        return NULL;
    }
                ...
                *pageBind = v;
                ...
                if (uPtr(p)->IsRootingStarted())
                {
                    *nav = Navigation::TryFind(p);
                    ...
                    if (*nav == NULL)
                    {
                        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[15/*"`Page` set ...*/], p, ::STRINGS[1/*"/usr/local/...*/], 1239, ::STRINGS[14/*"TryFindPage"*/]);
                        return NULL;
                    }
                }
...
void NavigationPageProxy::OnPageRootingCompleted()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Got an unde...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1369, ::STRINGS[17/*"OnPageRooti...*/]);
        return;
    }
...
void NavigationPageProxy::Rooted(::g::Fuse::Visual* source)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Attempting ...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1332, ::STRINGS[19/*"Rooted"*/]);
        return;
    }
    ...
    if (Page() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[20/*"Unable to l...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1339, ::STRINGS[19/*"Rooted"*/]);
        return;
    }
    ...
    if (_navigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[21/*"Something w...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1356, ::STRINGS[19/*"Rooted"*/]);
        return;
    }
...
void NavigationTriggerAction__Perform_fn(NavigationTriggerAction* __this, ::g::Fuse::Node* n)
{
    ...
    if (ctx == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[22/*"No navigati...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 3639, ::STRINGS[2/*"Perform"*/]);
        return;
    }
...
static void Router_build(uType* type)
{
    ...
    ::TYPES[28] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Navigation::Route_typeof());
    ::TYPES[29] = ::g::Fuse::Navigation::IRouterOutlet_typeof();
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[12] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[13] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    ...
    ::TYPES[33] = ::g::Fuse::Scripting::Marshal_typeof()->MakeMethod(1, ::g::Fuse::Navigation::ModifyRouteHow_typeof());
    ::TYPES[34] = ::g::Fuse::Scripting::IArray_typeof();
    ::TYPES[35] = ::g::Fuse::Scripting::Marshal_typeof()->MakeMethod(1, ::g::Fuse::Navigation::NavigationGotoMode_typeof());
    ::TYPES[36] = ::g::Fuse::Input::KeyPressedHandler_typeof();
    ::TYPES[9] = uObject_typeof()->Array();
    ::TYPES[37] = ::g::Uno::String_typeof();
    ::TYPES[38] = ::g::Fuse::Scripting::Array_typeof();
...
void Router::ctor_2()
{
    ...
    _history = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[28/*Uno.Collections.List<Fuse.Navigation.Route>*/]));
    ctor_1();
}
...
{
    ::g::Fuse::Node* ret2;
    uObject* ro = uAs<uObject*>(active, ::TYPES[29/*Fuse.Navigation.IRouterOutlet*/]);

    if ((ro != NULL) && ((::g::Fuse::Navigation::IRouterOutlet::Type(uInterface(uPtr(ro), ::TYPES[29/*Fuse.Navigation.IRouterOutlet*/])) & 2) == 2))
        return ro;
...
::g::Fuse::Navigation::Route* Router::GetCurrent(::g::Fuse::Visual* from, uObject* to)
{
    ...
    uString* opath;
    uString* oparameter;
    ::g::Fuse::Navigation::IRouterOutlet::GetCurrent(uInterface(uPtr(outlet), ::TYPES[29/*Fuse.Navigation.IRouterOutlet*/]), &opath, &oparameter, &from);
...
void Router::Pop()
{
    ...
    if (uPtr(_history)->Count() == 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Cannot pop(...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2339, ::STRINGS[55/*"Pop"*/]);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::SetRoute(::g::Fuse::Navigation::Route* r, int gotoMode, int operation, bool userRequest)
{
    ...
    if (outR == NULL)
    {
        ...
        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, ::STRINGS[1/*"/usr/local/...*/], 2361, ::STRINGS[57/*"SetRoute"*/]);
        else 
            ::g::Fuse::Diagnostics::InternalError(msg, this, ::STRINGS[1/*"/usr/local/...*/], 2363, ::STRINGS[57/*"SetRoute"*/]);
...
::g::Fuse::Navigation::Route* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::Route* r, int gotoMode, int operation)
{
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[58/*"No router o...*/], r), this, ::STRINGS[1/*"/usr/local/...*/], 2380, ::STRINGS[59/*"SetRouteImpl"*/]);
        return NULL;
    }

    int didTransition = ::g::Fuse::Navigation::IRouterOutlet::Goto(uInterface(uPtr(outlet), ::TYPES[29/*Fuse.Navigation.IRouterOutlet*/]), uPtr(r)->Path, uPtr(r)->Parameter, gotoMode, operation);
    ...
    uString* opath;
    uString* oparameter;
    ::g::Fuse::Navigation::IRouterOutlet::GetCurrent(uInterface(outlet, ::TYPES[29/*Fuse.Navigation.IRouterOutlet*/]), &opath, &oparameter, &active);
    ...
    if (r->SubRoute != NULL)
    {
        if (active == NULL)
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[60/*"SubRoute re...*/], r), this, ::STRINGS[1/*"/usr/local/...*/], 2402, ::STRINGS[59/*"SetRouteImpl"*/]);
            return NULL;
        }
        else 
        {
...
::g::Fuse::Navigation::Route* Router::GetRelative(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[34/*"Router.goto...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1792, ::STRINGS[35/*"GetRelative"*/]);
        return NULL;
    }
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[36/*"Router.goto...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1800, ::STRINGS[35/*"GetRelative"*/]);
        return NULL;
    }
...
void Router::GetRoute(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[37/*"Router.getR...*/], r, ::STRINGS[1/*"/usr/local/...*/], 2038, ::STRINGS[38/*"GetRoute"*/]);
        return;
    }
    ...
    if (callback == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[39/*"Router.getR...*/], r, ::STRINGS[1/*"/usr/local/...*/], 2044, ::STRINGS[38/*"GetRoute"*/]);
        return;
    }
...
void Router::GoBack1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[40/*"Router.goBa...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1847, ::STRINGS[41/*"GoBack"*/]);
        return;
    }
...
void Router::Goto1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[42/*"Router.goto...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1739, ::STRINGS[43/*"Goto"*/]);
}
...
void Router::Modify1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[44/*"`Router.mod...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1887, ::STRINGS[45/*"Modify"*/]);
        return;
    }

    ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[32/*Fuse.Scripting.Object*/]);

    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[46/*"`Router.mod...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1894, ::STRINGS[45/*"Modify"*/]);
        return;
    }
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        if (::g::Uno::String::op_Equality(p, ::STRINGS[47/*"how"*/]))
            how = (::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[33/*Fuse.Scripting.Marshal.ToType<Fuse.Navigation.ModifyRouteHow>*/], o, &ret4), ret4);
        else  if (::g::Uno::String::op_Equality(p, ::STRINGS[48/*"path"*/]))
        {
            uObject* path = uAs<uObject*>(o, ::TYPES[34/*Fuse.Scripting.IArray*/]);

            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"`path` shou...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1917, ::STRINGS[45/*"Modify"*/]);
                return;
            }
        ...
        else  if (::g::Uno::String::op_Equality(p, ::STRINGS[50/*"relative"*/]))
        {
            ...
            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[51/*"Could not f...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1929, ::STRINGS[45/*"Modify"*/]);
                return;
            }
        }
        else  if (::g::Uno::String::op_Equality(p, ::STRINGS[52/*"transition"*/]))
            mode = (::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[35/*Fuse.Scripting.Marshal.ToType<Fuse.Navigation.NavigationGotoMode>*/], o, &ret5), ret5);
        else 
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[53/*"Unrecognize...*/], p), r, ::STRINGS[1/*"/usr/local/...*/], 1939, ::STRINGS[45/*"Modify"*/]);
            return;
        }
    }
...
{
    Router_typeof()->Init();
    uArray* cvt = uArray::New(::TYPES[9/*object[]*/], ::g::Fuse::Scripting::IArray::Length(uInterface(uPtr(path), ::TYPES[34/*Fuse.Scripting.IArray*/])));

    for (int i = 0; i < cvt->Length(); ++i)
        uPtr(cvt)->Strong<uObject*>(i) = ::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(path), ::TYPES[34/*Fuse.Scripting.IArray*/]), i);
...
bool Router::ValidateParameter(::g::Fuse::Scripting::Context* c, uObject* arg, int depth)
{
    ...
    if (depth > 50)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[61/*"Route param...*/], NULL, ::STRINGS[1/*"/usr/local/...*/], 1957, ::STRINGS[62/*"ValidatePar...*/]);
        return false;
    }
    ...
    if (uIs(arg, ::TYPES[32/*Fuse.Scripting.Object*/]))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::STRINGS[63/*"Route param...*/], NULL, ::STRINGS[1/*"/usr/local/...*/], 1966, ::STRINGS[62/*"ValidatePar...*/]);
            return false;
        }
    ...
    if (uIs(arg, ::TYPES[38/*Fuse.Scripting.Array*/]))
    {
        ::g::Fuse::Scripting::Array* arr = uCast< ::g::Fuse::Scripting::Array*>(arg, ::TYPES[38/*Fuse.Scripting.Array*/]);
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[64/*"Route param...*/], NULL, ::STRINGS[1/*"/usr/local/...*/], 1989, ::STRINGS[62/*"ValidatePar...*/]);
        return false;
    }
...
static void StructuredNavigation_build(uType* type)
{
    ...
    ::TYPES[42] = ::g::Fuse::Motion::Simulation::MotionSimulation_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[13] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    type->SetInterfaces(
...
void StructuredNavigation__FuseNavigationISeekableNavigationEndSeek_fn(StructuredNavigation* __this, ::g::Fuse::Navigation::EndSeekArgs* args)
{
    ...
    if (!__this->TransitionToChild(__this->GetPage(targetIndex), false, true))
        ::g::Fuse::Motion::Simulation::BoundedRegion2D::Reset(uInterface(uPtr(__this->_region), ::TYPES[41/*Fuse.Motion.Simulation.BoundedRegion2D*/]), (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(__this->_region), ::TYPES[42/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret8), ret8));
}
...
void StructuredNavigation__FuseNavigationISeekableNavigationSeek_fn(StructuredNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[65/*"Seek being ...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 3075, ::STRINGS[66/*"Fuse.Naviga...*/]);
        return;
    }
    ...
    __this->ChangeProgress(prev, (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(__this->_region), ::TYPES[42/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret9), ret9).X, 2);
...
void StructuredNavigation__OnUnrooted_fn(StructuredNavigation* __this)
{
    ...
    if (__this->_region != NULL)
    {
        __this->_progress = (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(__this->_region), ::TYPES[42/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret11), ret11).X;
        __this->_region = NULL;
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[67/*"Attempting ...*/], element, ::STRINGS[1/*"/usr/local/...*/], 2782, ::STRINGS[68/*"GotoImpl"*/]);
        SetActive(NULL);
        return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[71/*"Motion shou...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2717, ::STRINGS[72/*"set_Motion"*/]);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[69/*"Updated cal...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2873, ::STRINGS[70/*"OnUpdated"*/]);
        return;
    }

    float prev = (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[42/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret12), ret12).X;
    ...
    ChangeProgress(prev, (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[42/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret13), ret13).X, 2);
...
{
    ::g::Uno::Float2 ret16;
    return (double)((_region == NULL) ? _progress : (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[42/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret16), ret16).X);
}
...
void StructuredNavigation::SetProgress(float value)
{
    ...
    {
        ResetRegionLimits();
        prev = (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[42/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret14), ret14).X;
        ...
        value = (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[42/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret15), ret15).X;
    }
    else 
    {
        prev = _progress;
...
{
    ::TYPES[43] = ::g::Fuse::Motion::Simulation::PointerVelocity_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[44] = ::g::Fuse::Gestures::DegreeSpan_typeof()->Array();
    ::TYPES[30] = ::g::Fuse::Node_typeof();
    ::TYPES[45] = ::g::Fuse::Navigation::ISeekableNavigation_typeof();
    ::TYPES[17] = ::g::Uno::Action_typeof();
    ::TYPES[46] = ::g::Fuse::Input::PointerPressedHandler_typeof();
    ::TYPES[47] = ::g::Fuse::Input::PointerMovedHandler_typeof();
    ::TYPES[48] = ::g::Fuse::Input::PointerReleasedHandler_typeof();
    ::TYPES[4] = ::g::Fuse::Elements::Element_typeof();
    type->SetInterfaces(
...
{
    ::g::Fuse::Node__OnRooted_fn(__this);
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Pressed()), __this->Parent(), uDelegate::New(::TYPES[46/*Fuse.Input.PointerPressedHandler*/], (void*)SwipeNavigate__OnPointerPressed_fn, __this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Moved()), __this->Parent(), uDelegate::New(::TYPES[47/*Fuse.Input.PointerMovedHandler*/], (void*)SwipeNavigate__OnPointerMoved_fn, __this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Released()), __this->Parent(), uDelegate::New(::TYPES[48/*Fuse.Input.PointerReleasedHandler*/], (void*)SwipeNavigate__OnPointerReleased_fn, __this));
}

// protected override sealed void OnUnrooted() :3299
void SwipeNavigate__OnUnrooted_fn(SwipeNavigate* __this)
{
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Pressed()), __this->Parent(), uDelegate::New(::TYPES[46/*Fuse.Input.PointerPressedHandler*/], (void*)SwipeNavigate__OnPointerPressed_fn, __this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Moved()), __this->Parent(), uDelegate::New(::TYPES[47/*Fuse.Input.PointerMovedHandler*/], (void*)SwipeNavigate__OnPointerMoved_fn, __this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Released()), __this->Parent(), uDelegate::New(::TYPES[48/*Fuse.Input.PointerReleasedHandler*/], (void*)SwipeNavigate__OnPointerReleased_fn, __this));
    ::g::Fuse::Node__OnUnrooted_fn(__this);
}
...
void SwipeNavigate::ctor_3()
{
    ...
    _forwardDirection = 1;
    _horizontalGesture = ::g::Fuse::Gestures::SwipeGestureHelper::New1(10.0f, uArray::Init< ::g::Fuse::Gestures::DegreeSpan*>(::TYPES[44/*Fuse.Gestures.DegreeSpan[]*/], 2, (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(75.0f, 105.0f), (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(-75.0f, -105.0f)));
    _verticalGesture = ::g::Fuse::Gestures::SwipeGestureHelper::New1(10.0f, uArray::Init< ::g::Fuse::Gestures::DegreeSpan*>(::TYPES[44/*Fuse.Gestures.DegreeSpan[]*/], 3, (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(-15.0f, 15.0f), (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(-165.0f, -180.0f), (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(165.0f, 180.0f)));
    _down = -1;
    _swipeAllow = 3;
    ctor_2();
...
void SwipeNavigate::OnLostCapture()
{
    ...
    if (_currentNavigation != NULL)
    {
        if (uPtr(uAs< ::g::Fuse::Node*>(_currentNavigation, ::TYPES[30/*Fuse.Node*/]))->IsRootingCompleted())
            ::g::Fuse::Navigation::ISeekableNavigation::EndSeek(uInterface(uPtr(_currentNavigation), ::TYPES[45/*Fuse.Navigation.ISeekableNavigation*/]), ::g::Fuse::Navigation::EndSeekArgs::New1(1, 0.0f));
...
void SwipeNavigate::OnPointerMoved(uObject* sender, ::g::Fuse::Input::PointerMovedArgs* args)
{
    ...
    if (args->IsHardCapturedTo(this))
        ::g::Fuse::Navigation::ISeekableNavigation::Seek(uInterface(uPtr(_currentNavigation), ::TYPES[45/*Fuse.Navigation.ISeekableNavigation*/]), GetNavigationArgs());
    else 
    {
        ...
        if (withinBounds)
        {
            ...
            if (args->TryHardCapture(this, uDelegate::New(::TYPES[17/*Uno.Action*/], (void*)SwipeNavigate__OnLostCapture_fn, this), NULL))
                ::g::Fuse::Navigation::ISeekableNavigation::BeginSeek(uInterface(uPtr(_currentNavigation), ::TYPES[45/*Fuse.Navigation.ISeekableNavigation*/]));
            else 
                OnLostCapture();
        }
    }
...
void SwipeNavigate::OnPointerReleased(uObject* sender, ::g::Fuse::Input::PointerReleasedArgs* args)
{
    ...
    if (args->IsHardCapturedTo(this))
    {
        ::g::Fuse::Navigation::ISeekableNavigation::EndSeek(uInterface(uPtr(_currentNavigation), ::TYPES[45/*Fuse.Navigation.ISeekableNavigation*/]), ::g::Fuse::Navigation::EndSeekArgs::New1(DetermineSnap(), ProgressVelocity()));
...
static void VisualNavigation__cctor_1_fn(uType* __type)
{
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(VisualNavigation_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[25/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[49/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.VisualNavigation>*/], ::STRINGS[27/*"goto"*/], uDelegate::New(::TYPES[50/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.VisualNavigation, object[]>*/], (void*)VisualNavigation__gotoNode_fn), 2)));
}
...
static void VisualNavigation_build(uType* type)
{
    ...
    ::TYPES[24] = ::g::Uno::Type_typeof();
    ::TYPES[25] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[49] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(VisualNavigation_typeof());
    ::TYPES[50] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), VisualNavigation_typeof(), uObject_typeof()->Array());
    ::TYPES[51] = ::g::Uno::Collections::List_typeof()->MakeType(VisualNavigation__PageData_typeof());
    ::TYPES[52] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Visual_typeof(), VisualNavigation__PageData_typeof());
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[12] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[13] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
...
{
    _pages = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[51/*Uno.Collections.List<Fuse.Navigation.VisualNavigation.PageData>*/]));
    _pageMap = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[52/*Uno.Collections.Dictionary<Fuse.Visual, Fuse.Navigation.VisualNavigation.PageData>*/]));
    ctor_2();
}
...
void VisualNavigation::gotoNode(::g::Fuse::Scripting::Context* c, VisualNavigation* nav, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[74/*"Navigation....*/], nav, ::STRINGS[1/*"/usr/local/...*/], 3864, ::STRINGS[75/*"gotoNode"*/]);
}
// }
