...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/0.39.3/android/$.uno
// -----------------------------------------------------------------------
...
// public Switch(Fuse.Controls.Native.IToggleViewHost host) :1896
void Switch__ctor__fn(Switch* __this, uObject* host)
{
    __this->ctor_(host);
}

// public Switch New(Fuse.Controls.Native.IToggleViewHost host) :1896
void Switch__New1_fn(uObject* host, Switch** __retval)
{
    *__retval = Switch::New1(host);
}

// public void set_Value(bool value) :1892
void Switch__set_Value_fn(Switch* __this, bool* value)
{
    __this->Value(*value);
}

// public Switch(Fuse.Controls.Native.IToggleViewHost host) [instance] :1896
void Switch::ctor_(uObject* host)
{
}

// public void set_Value(bool value) [instance] :1892
void Switch::Value(bool value)
{
}

// public Switch New(Fuse.Controls.Native.IToggleViewHost host) [static] :1896
