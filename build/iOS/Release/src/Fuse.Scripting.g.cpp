...
// /usr/local/share/uno/Packages/Fuse.Scripting/0.39.3/$.uno
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.39.3/scripting/$.uno
// -------------------------------------------------------------
...
static void Context_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.39.3/scripting/$.uno");
...
::g::Uno::Float4 Marshal::ToFloat41(uObject* o)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[45/*"Unable to c...*/], o), ::STRINGS[48/*" to float4"*/])));
}
...
void Context__MethodClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Scripting::Context* context)
{
    _m = m;
    _context = context;
    ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(_context)->Evaluate(::g::Uno::String::op_Addition2(uPtr(m)->Name, ::STRINGS[25/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[57/*"(function (...*/], uPtr(m)->Name), ::STRINGS[58/*" = function...*/])), ::TYPES[17/*Fuse.Scripting.Function*/]);
...
void ModuleResult::OnDisposed()
{
    ...
    {
        ::g::Fuse::Scripting::Array* disposed = uAs< ::g::Fuse::Scripting::Array*>(uPtr(Object)->Item(::STRINGS[60/*"disposed"*/]), ::TYPES[18/*Fuse.Scripting.Array*/]);
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[59/*"exports"*/]), ::TYPES[9/*Fuse.Scripting.Object*/]);
...
void Observable::ctor_2(::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Object* obj, bool supressCallback)
{
    ...
    uPtr(obj)->CallMethod(::STRINGS[64/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (::g::Fuse::Scripting::Function*)_observeChange, uBox(::TYPES[53/*bool*/], supressCallback)));
}
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    ::STRINGS[96] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/0.39.3/$.uno");
...
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[90/*"require(): ...*/], uBox<int>(::TYPES[36/*int*/], uPtr(args)->Length())), ::STRINGS[91/*" provided"*/])));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        else 
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[94/*"JavaScript ...*/], path), ::STRINGS[98/*" line "*/]), uBox<int>(::TYPES[36/*int*/], uPtr(e)->LineNumber())), ::STRINGS[99/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[96/*"/usr/local/...*/], 214, ::STRINGS[97/*"Require"*/]);
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[106/*"Cannot call...*/], __this, ::STRINGS[7/*"/usr/local/...*/], 2167, ::STRINGS[107/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
uString* ScriptModule::ComputePath(uString* moduleId, bool* isFile)
{
    if (::g::Uno::String::EndsWith(uPtr(moduleId), ::STRINGS[109/*".js"*/]))
        moduleId = ::g::Uno::String::Replace1(uPtr(moduleId), ::STRINGS[109/*".js"*/], ::STRINGS[15/*""*/]);
...
{
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[66/*"clear"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, uBox<int>(::TYPES[36/*int*/], _origin)));
}
...
void Observable__Subscription::ReplaceAllExclusive(uType* __type, uArray* newValues)
{
    ...
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[120/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, sa, uBox<int>(::TYPES[36/*int*/], _origin)));
}
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[121/*"Unexpected ...*/], this, ::STRINGS[7/*"/usr/local/...*/], 1490, ::STRINGS[122/*"SetExclusive"*/]);
        return;
    }

    try
    {
        uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[123/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (uObject*)uPtr(uPtr(_om)->_context)->Unwrap(newValue), uBox<int>(::TYPES[36/*int*/], _origin)));
    }
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[65/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[124/*"Failed to s...*/], ex, this, ::STRINGS[7/*"/usr/local/...*/], 1502, ::STRINGS[122/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
