...
// public TextRenderer(Fuse.Controls.TextControl control) :890
void TextRenderer__ctor__fn(TextRenderer* __this, ::g::Fuse::Controls::TextControl* control)
{
    __this->ctor_(control);
}

// public void Arrange(float2 position, float2 size) :984
void TextRenderer__Arrange_fn(TextRenderer* __this, ::g::Uno::Float2* position, ::g::Uno::Float2* size)
{
    __this->Arrange(*position, *size);
}

// private static Fuse.iOS.Bindings.CGContextRef CGBitmapContextCreate(Uno.IntPtr textureBuffer, int width, int height, Fuse.iOS.Bindings.CGColorSpaceRef colorSpace) :956
...
// private static Fuse.iOS.Bindings.CGColorSpaceRef CGColorSpaceCreateDeviceRGB() :879
...
// private static void CGContextRelease(Fuse.iOS.Bindings.CGContextRef context) :962
void TextRenderer__CGContextRelease_fn(::CGContextRef* context)
{
    TextRenderer::CGContextRelease(*context);
}

// internal static Fuse.Controls.ITextRenderer Create(Fuse.Controls.TextControl control) :881
void TextRenderer__Create_fn(::g::Fuse::Controls::TextControl* control, uObject** __retval)
{
    *__retval = TextRenderer::Create(control);
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) :911
void TextRenderer__Draw_fn(TextRenderer* __this, ::g::Fuse::DrawContext* dc, ::g::Fuse::Visual* where)
{
    __this->Draw(dc, where);
}

// private static void DrawGlyphs(Fuse.iOS.Bindings.CGContextRef context, float x, float y, int width, int height, ObjC.Object layoutManager, ObjC.Object textContainer) :965
...
// public float2 GetContentSize(Fuse.LayoutParams lp) :895
...
// public TextRenderer(Fuse.Controls.TextControl control) [instance] :890
...
// public void Arrange(float2 position, float2 size) [instance] :984
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) [instance] :911
...
// public float2 GetContentSize(Fuse.LayoutParams lp) [instance] :895
...
// public Uno.Rect GetRenderBounds() [instance] :1016
...
// public void Invalidate() [instance] :994
...
// private void InvalidateTexture() [instance] :1007
...
// public void SoftDispose() [instance] :1002
void TextRenderer::SoftDispose()
{
    InvalidateTexture();
}

// private static Fuse.iOS.Bindings.CGContextRef CGBitmapContextCreate(Uno.IntPtr textureBuffer, int width, int height, Fuse.iOS.Bindings.CGColorSpaceRef colorSpace) [static] :956
...
// private static Fuse.iOS.Bindings.CGColorSpaceRef CGColorSpaceCreateDeviceRGB() [static] :879
...
// private static void CGContextRelease(Fuse.iOS.Bindings.CGContextRef context) [static] :962
...
// internal static Fuse.Controls.ITextRenderer Create(Fuse.Controls.TextControl control) [static] :881
...
// private static void DrawGlyphs(Fuse.iOS.Bindings.CGContextRef context, float x, float y, int width, int height, ObjC.Object layoutManager, ObjC.Object textContainer) [static] :965
...
// public TextRenderer New(Fuse.Controls.TextControl control) [static] :890
