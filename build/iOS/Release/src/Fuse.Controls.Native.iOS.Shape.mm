...
// internal abstract extern class Shape :1926
// {
static void Shape_build(uType* type)
{
    ::STRINGS[0] = uString::Const("");
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Native/0.39.3/ios/$.uno");
...
// private void Fuse.Controls.Native.IShapeView.Update(Fuse.Drawing.Brush[] fills, Fuse.Drawing.Stroke[] strokes, float pixelsPerPoint) :1967
...
// private static void MakeLayers(ObjC.Object handle, int layerCount) :2155
void Shape__MakeLayers_fn(uObject* handle, int* layerCount)
{
    Shape::MakeLayers(handle, *layerCount);
}

// protected void OnShapeChanged() :1973
void Shape__OnShapeChanged_fn(Shape* __this)
{
    __this->OnShapeChanged();
}

// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) :2025
...
// private void SetBrush(Fuse.Drawing.Brush brush, int layer, ObjC.Object path, bool isLine, float strokeWidth) :2001
...
// private static void SetBrush(ObjC.Object handle, float r, float g, float b, float a, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float opacity) :2133
...
// private void SetLinearGradient(Fuse.Drawing.LinearGradient gradient, int layer, ObjC.Object path, bool isLine, float strokeWidth) :2030
...
// private static void SetLinearGradient(ObjC.Object handle, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, float[] colors, float[] offsets, float width, float height) :2062
...
// public override sealed void set_Transform(float4x4 value) :1946
...
// protected Shape(Fuse.Visual visual) [instance] :1931
...
// protected void OnShapeChanged() [instance] :1973
...
// private void SetBrush(Fuse.Drawing.Brush brush, int layer, ObjC.Object path, bool isLine, float strokeWidth) [instance] :2001
void Shape::SetBrush(::g::Fuse::Drawing::Brush* brush, int layer, uObject* path, bool isLine, float strokeWidth)
{
    ...
    else 
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*""*/], brush, ::STRINGS[1/*"/usr/local/...*/], 2018, ::STRINGS[2/*"SetBrush"*/]);
...
// private void SetLinearGradient(Fuse.Drawing.LinearGradient gradient, int layer, ObjC.Object path, bool isLine, float strokeWidth) [instance] :2030
...
// protected generated float2 get_ShapePosition() [instance] :1943
::g::Uno::Float2 Shape::ShapePosition()
{
    return _ShapePosition;
}

// private generated void set_ShapePosition(float2 value) [instance] :1943
void Shape::ShapePosition(::g::Uno::Float2 value)
{
    _ShapePosition = value;
}

// protected generated float2 get_ShapeSize() [instance] :1954
::g::Uno::Float2 Shape::ShapeSize()
{
    return _ShapeSize;
}

// private generated void set_ShapeSize(float2 value) [instance] :1954
void Shape::ShapeSize(::g::Uno::Float2 value)
{
    _ShapeSize = value;
}

// private static ObjC.Object Create() [static] :2171
...
// private static void MakeLayers(ObjC.Object handle, int layerCount) [static] :2155
...
// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) [static] :2025
...
// private static void SetBrush(ObjC.Object handle, float r, float g, float b, float a, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float opacity) [static] :2133
...
// private static void SetLinearGradient(ObjC.Object handle, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, float[] colors, float[] offsets, float width, float height) [static] :2062
