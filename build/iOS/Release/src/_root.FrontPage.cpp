...
// {
// static FrontPage() :11
static void FrontPage__cctor_4_fn(uType* __type)
{
    FrontPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 1, ::STRINGS[0/*"router"*/]);
}

static void FrontPage_build(uType* type)
{
    ::STRINGS[0] = uString::Const("router");
    ::STRINGS[1] = uString::Const("goToLogin");
    ::STRINGS[2] = uString::Const("createUser");
    ::STRINGS[3] = uString::Const("Pages/FrontPage.ux");
    ::STRINGS[4] = uString::Const("Login");
    ::STRINGS[5] = uString::Const("Create User");
    ...
    type->SetFields(92,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::FrontPage, __g_nametable1), 0,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(::g::FrontPage, router), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::FrontPage, temp_eb0), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::FrontPage, temp_eb1), 0,
        ::g::Uno::String_typeof()->Array(), (uintptr_t)&::g::FrontPage::__g_static_nametable1_, uFieldFlagsStatic);
}
...
::g::Fuse::Controls::Control_type* FrontPage_typeof()
{
    ...
    options.ObjectSize = sizeof(FrontPage);
    options.TypeSize = sizeof(::g::Fuse::Controls::Control_type);
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("FrontPage", options);
    type->fp_build_ = FrontPage_build;
    type->fp_cctor_ = FrontPage__cctor_4_fn;
...
// public FrontPage(Fuse.Navigation.Router router) :15
...
// public FrontPage New(Fuse.Navigation.Router router) :15
void FrontPage__New5_fn(::g::Fuse::Navigation::Router* router1, FrontPage** __retval)
{
    *__retval = FrontPage::New5(router1);
}

uSStrong<uArray*> FrontPage::__g_static_nametable1_;

// public FrontPage(Fuse.Navigation.Router router) [instance] :15
void FrontPage::ctor_8(::g::Fuse::Navigation::Router* router1)
{
    ctor_7();
    router = router1;
    InitializeUX();
...
void FrontPage::InitializeUX()
{
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, FrontPage::__g_static_nametable1());
    ...
    ::g::Fuse::Controls::Button* temp3 = ::g::Fuse::Controls::Button::New5();
    temp_eb0 = ::g::Fuse::Reactive::EventBinding::New1(::STRINGS[1/*"goToLogin"*/]);
    ::g::Fuse::Controls::Button* temp4 = ::g::Fuse::Controls::Button::New5();
    temp_eb1 = ::g::Fuse::Reactive::EventBinding::New1(::STRINGS[2/*"createUser"*/]);
    temp->LineNumber(3);
    temp->FileName(::STRINGS[3/*"Pages/Front...*/]);
    temp->File(::g::Uno::UX::BundleFileSource::New1(::g::Zmart_bundle::FrontPage21437355()));
    ...
    temp4->Text(::STRINGS[5/*"Create User"*/]);
    ::g::Fuse::Gestures::Clicked::AddHandler(temp4, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb1)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb1);
...
// public FrontPage New(Fuse.Navigation.Router router) [static] :15
FrontPage* FrontPage::New5(::g::Fuse::Navigation::Router* router1)
{
    FrontPage* obj1 = (FrontPage*)uNew(FrontPage_typeof());
    obj1->ctor_8(router1);
    return obj1;
}
// }
