...
// public abstract extern class View :3317
// {
static void View_build(uType* type)
{
    ::STRINGS[0] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Native/0.39.3/ios/$.uno");
...
// private static void SetSize(ObjC.Object handle, float w, float h) :3479
void View__SetSize_fn(uObject* handle, float* w, float* h)
{
    View::SetSize(handle, *w, *h);
}

// public static void SetTransform(ObjC.Object handle, float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24, float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44) :3512
...
// public static void Show(ObjC.Object handle) :3423
void View__Show1_fn(uObject* handle)
{
    View::Show1(handle);
}

// public virtual void set_Size(float2 value) :3402
...
// public virtual void set_Transform(float4x4 value) :3362
...
// protected View(ObjC.Object handle) [instance] :3335
...
// public void set_Background(Fuse.Drawing.Brush value) [instance] :3375
void View::Background(::g::Fuse::Drawing::Brush* value)
{
    ...
    if (value != NULL)
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::g::Uno::Object::ToString(this), value, ::STRINGS[0/*"/usr/local/...*/], 3388, ::STRINGS[1/*"set_Backgro...*/]);
    }

    View::SetBackground(Handle(), c.X, c.Y, c.Z, c.W);
}

// public void set_ClipToBounds(bool value) [instance] :3350
void View::ClipToBounds(bool value)
{
    View::SetClipToBounds(Handle(), value);
}

// public ObjC.Object get_Handle() [instance] :3319
uObject* View::Handle()
{
    return _handle;
}

// public void Hide() [instance] :3416
void View::Hide()
{
    View::Hide1(Handle());
}

// public void set_Opacity(float value) [instance] :3456
void View::Opacity(float value)
{
    View::SetAlpha(Handle(), value);
}

// internal Fuse.Controls.Native.iOS.ViewParent get_Parent() [instance] :3324
::g::Fuse::Controls::Native::iOS::ViewParent* View::Parent()
{
    return _parent;
}

// internal void set_Parent(Fuse.Controls.Native.iOS.ViewParent value) [instance] :3325
...
// public void Show() [instance] :3411
void View::Show()
{
    View::Show1(Handle());
}

// public static void Hide(ObjC.Object handle) [static] :3431
...
// private static void SetAlpha(ObjC.Object handle, float a) [static] :3472
...
// public static void SetAnchorPoint(ObjC.Object handle) [static] :3342
...
// private static void SetBackground(ObjC.Object handle, float r, float g, float b, float a) [static] :3529
...
// private static void SetSize(ObjC.Object handle, float w, float h) [static] :3479
...
// public static void SetTransform(ObjC.Object handle, float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24, float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44) [static] :3512
