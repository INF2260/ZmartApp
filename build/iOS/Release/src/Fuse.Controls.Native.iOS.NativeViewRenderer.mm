...
// internal sealed extern class NativeViewRenderer :1436
// {
...
// public NativeViewRenderer(ObjC.Object viewHandle) :1443
void NativeViewRenderer__ctor__fn(NativeViewRenderer* __this, uObject* viewHandle)
{
    __this->ctor_(viewHandle);
}

// private void DeleteTexture() :1553
void NativeViewRenderer__DeleteTexture_fn(NativeViewRenderer* __this)
{
    __this->DeleteTexture();
}

// private static void Draw(ObjC.Object viewHandle, int textureName, Uno.IntPtr pixelBufferHandle, int width, int height, float density, bool reuse) :1490
...
// private static void FreePixelBuffer(Uno.IntPtr buffer) :1594
void NativeViewRenderer__FreePixelBuffer_fn(void** buffer)
{
    NativeViewRenderer::FreePixelBuffer(*buffer);
}

// private void Fuse.Controls.Native.INativeViewRenderer.Draw(float4x4 localToClipTransform, float2 position, float2 size, float density) :1449
...
// private void Uno.IDisposable.Dispose() :1567
...
// public NativeViewRenderer(ObjC.Object viewHandle) [instance] :1443
...
// private void DeleteTexture() [instance] :1553
...
// private static void Draw(ObjC.Object viewHandle, int textureName, Uno.IntPtr pixelBufferHandle, int width, int height, float density, bool reuse) [static] :1490
...
// private static void FreePixelBuffer(Uno.IntPtr buffer) [static] :1594
void NativeViewRenderer::FreePixelBuffer(void* buffer)
{
    free( buffer );
}

// private static Uno.IntPtr MallocPixelBuffer(int size) [static] :1589
void* NativeViewRenderer::MallocPixelBuffer(int size)
{
    return malloc( size );
}

// public NativeViewRenderer New(ObjC.Object viewHandle) [static] :1443
