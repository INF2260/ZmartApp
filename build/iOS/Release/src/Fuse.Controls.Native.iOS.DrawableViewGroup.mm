...
// public void Add(Fuse.Controls.Native.iOS.View child) :215
void DrawableViewGroup__Add_fn(DrawableViewGroup* __this, ::g::Fuse::Controls::Native::iOS::View* child)
{
    __this->Add(child);
}

// public void Add(Fuse.Controls.Native.iOS.View child, int index) :221
...
// private static void Add(ObjC.Object parentHandle, ObjC.Object childHandle) :247
void DrawableViewGroup__Add2_fn(uObject* parentHandle, uObject* childHandle)
{
    DrawableViewGroup::Add2(parentHandle, childHandle);
}

// private static void Add(ObjC.Object parentHandle, ObjC.Object childHandle, int index) :255
...
// private static ObjC.Object Create() :271
void DrawableViewGroup__Create_fn(uObject** __retval)
{
    *__retval = DrawableViewGroup::Create();
}

// private static ObjC.Object CreateContainer() :288
...
// private void Fuse.Controls.Native.INativeViewRenderer.Draw(float4x4 localToClipTransform, float2 position, float2 size, float density) :163
...
// private void Fuse.Controls.Native.INativeViewRenderer.Invalidate() :174
...
// private void Fuse.Controls.Native.IOffscreenRenderer.DisableOffscreen() :190
...
// private void Fuse.Controls.Native.IOffscreenRenderer.EnableOffscreen() :180
...
// private void Fuse.Controls.Native.IViewGroup.Add(Fuse.Controls.Native.IView child) :200
...
// private void Fuse.Controls.Native.IViewGroup.Add(Fuse.Controls.Native.IView child, int index) :210
...
// private void Fuse.Controls.Native.IViewGroup.Remove(Fuse.Controls.Native.IView child) :205
...
// public override sealed void NotifyChildNewSize(Fuse.Controls.Native.iOS.View child, float2 size) :297
...
// private static void UpdateFrame(ObjC.Object sourceHandle, ObjC.Object targetHandle) :239
...
// public void Add(Fuse.Controls.Native.iOS.View child) [instance] :215
...
// public void Add(Fuse.Controls.Native.iOS.View child, int index) [instance] :221
...
// private void OnSetFrame(ObjC.Object handle) [instance] :233
void DrawableViewGroup::OnSetFrame(uObject* handle)
{
    DrawableViewGroup::UpdateFrame(handle, _container);
}

// public void Remove(Fuse.Controls.Native.iOS.View child) [instance] :227
...
// private static void Add(ObjC.Object parentHandle, ObjC.Object childHandle) [static] :247
...
// private static void Add(ObjC.Object parentHandle, ObjC.Object childHandle, int index) [static] :255
...
// private static ObjC.Object Create() [static] :271
...
// private static ObjC.Object CreateContainer() [static] :288
...
// private static void Remove(ObjC.Object childHandle) [static] :263
...
// private static void SetSetFrameCallback(ObjC.Object handle, Uno.Action<ObjC.Object> callback) [static] :281
...
// private static void UpdateFrame(ObjC.Object sourceHandle, ObjC.Object targetHandle) [static] :239
