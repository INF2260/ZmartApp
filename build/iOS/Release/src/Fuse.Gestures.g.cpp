...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.39.3/$.uno
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.39.3/internal/$.uno
// -----------------------------------------------------------------
...
static void Scroller_build(uType* type)
{
    ...
    ::TYPES[13] = ::g::Fuse::Motion::Simulation::PointerVelocity_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[14] = ::g::Fuse::Motion::Simulation::Simulation_typeof();
    ::TYPES[4] = ::g::Uno::Action_typeof();
    ::TYPES[15] = ::g::Fuse::Motion::Simulation::MotionSimulation_typeof()->MakeType(::g::Uno::Float2_typeof());
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Gestures/0.39.3/$.uno");
...
{
    ::TYPES[2] = ::g::Fuse::Gestures::ClickerEventHandler_typeof();
    ::TYPES[20] = ::g::Fuse::Gestures::TappedHandler_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
{
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Handler1, value), ::TYPES[20/*Fuse.Gestures.TappedHandler*/]);
}
...
{
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Handler1, value), ::TYPES[20/*Fuse.Gestures.TappedHandler*/]);
}
