...
{
    FuseControlsVideo_bundle::Scale9Rectangleda875692_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[27/*"uniform flo...*/], ::STRINGS[28/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[29/*"q"*/]));
    FuseControlsVideo_bundle::VideoDrawElement5c829975_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[30/*"uniform mat...*/], ::STRINGS[31/*"uniform sam...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"b"*/], ::STRINGS[3/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[9/*"h"*/]));
}

static void FuseControlsVideo_bundle_build(uType* type)
{
    ::STRINGS[27] = uString::Const("uniform float c,d,e,f,g,h,k,l,m,n;uniform mat4 i,j;uniform vec2 o;attribute vec3 a,b;varying vec2 p;void main(){p=vec2(((a.x*c)+(a.y*k))+(a.z*l),((b.x*f)+(b.y*m))+(b.z*n))/o;gl_Position=j*(i*vec4(vec2(((a.x*c)+(a.y*d))+(a.z*e),((b.x*f)+(b.y*g))+(b.z*h)),float(0),float(1)));}");
    ::STRINGS[28] = uString::Const("uniform sampler2D q;varying vec2 p;void main(){gl_FragColor=vec4(texture2D(q,p).xyz,1.);}");
    ::STRINGS[3] = uString::Const("a");
    ::STRINGS[2] = uString::Const("b");
    ::STRINGS[4] = uString::Const("c");
    ::STRINGS[5] = uString::Const("d");
...
static void FuseCore_bundle__cctor__fn(uType* __type)
{
    ...
    FuseCore_bundle::RobotoRegular1f08fa7e_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[34/*"FuseCore"*/]))->GetFile(::STRINGS[35/*"roboto-regu...*/]);
}
...
{
    ::STRINGS[36] = uString::Const("attribute vec2 a;varying vec2 g;void main(){g=a;gl_Position=vec4((a.x*float(2))-float(1),(-a.y*float(2))+float(1),float(0),float(1));}");
    ::STRINGS[37] = uString::Const("uniform float d[b],e;uniform vec4 f[c];varying vec2 g;vec4 h(vec2 i){float j=d[0]+(e*i.x);vec4 k=f[0];for(int l=0;l<(b-1);l++){float m=d[l];float n=d[l+1];vec4 o=f[l+1];k=mix(k,o,smoothstep(m,n,j));}return k;}void main(){gl_FragColor=h(g);}");
    ::STRINGS[2] = uString::Const("b");
    ::STRINGS[4] = uString::Const("c");
    ::STRINGS[3] = uString::Const("a");
    ::STRINGS[5] = uString::Const("d");
...
{
    FuseDrawingPrimitives_bundle::Circle01247f96_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[38/*"uniform vec...*/], ::STRINGS[39/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[18/*"r"*/], ::STRINGS[40/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle038d0b56_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[41/*"uniform vec...*/], ::STRINGS[42/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 25, ::STRINGS[2/*"b"*/], ::STRINGS[3/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[18/*"r"*/], ::STRINGS[43/*"s"*/], ::STRINGS[44/*"t"*/], ::STRINGS[40/*"u"*/], ::STRINGS[45/*"v"*/], ::STRINGS[46/*"w"*/], ::STRINGS[47/*"x"*/], ::STRINGS[48/*"A"*/]));
    FuseDrawingPrimitives_bundle::Circle09647386_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[49/*"uniform vec...*/], ::STRINGS[50/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[43/*"s"*/]));
    FuseDrawingPrimitives_bundle::Circle09647387_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[51/*"uniform vec...*/], ::STRINGS[52/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[17/*"p"*/]));
    FuseDrawingPrimitives_bundle::Circle09647389_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[49/*"uniform vec...*/], ::STRINGS[53/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[43/*"s"*/]));
    FuseDrawingPrimitives_bundle::Circle27c6b7fe_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[38/*"uniform vec...*/], ::STRINGS[54/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[18/*"r"*/], ::STRINGS[40/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle27c6b7ff_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[55/*"uniform vec...*/], ::STRINGS[56/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[18/*"r"*/]));
    FuseDrawingPrimitives_bundle::Circle4a971b16_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[57/*"uniform vec...*/], ::STRINGS[58/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/]));
    FuseDrawingPrimitives_bundle::Circle4c78c62c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[59/*"uniform vec...*/], ::STRINGS[60/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 15, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/]));
    FuseDrawingPrimitives_bundle::Circle60e596bb_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[41/*"uniform vec...*/], ::STRINGS[61/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 25, ::STRINGS[2/*"b"*/], ::STRINGS[3/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[18/*"r"*/], ::STRINGS[43/*"s"*/], ::STRINGS[44/*"t"*/], ::STRINGS[40/*"u"*/], ::STRINGS[45/*"v"*/], ::STRINGS[46/*"w"*/], ::STRINGS[47/*"x"*/], ::STRINGS[48/*"A"*/]));
    FuseDrawingPrimitives_bundle::Circle7aaa5f74_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[62/*"uniform vec...*/], ::STRINGS[63/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/]));
    FuseDrawingPrimitives_bundle::Circle91c7af62_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[64/*"uniform vec...*/], ::STRINGS[65/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circlebe3e2220_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[66/*"uniform vec...*/], ::STRINGS[67/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 22, ::STRINGS[2/*"b"*/], ::STRINGS[3/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[18/*"r"*/], ::STRINGS[43/*"s"*/], ::STRINGS[44/*"t"*/], ::STRINGS[40/*"u"*/], ::STRINGS[47/*"x"*/]));
    FuseDrawingPrimitives_bundle::Circlecfb305c7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[68/*"uniform vec...*/], ::STRINGS[69/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 23, ::STRINGS[2/*"b"*/], ::STRINGS[3/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[18/*"r"*/], ::STRINGS[43/*"s"*/], ::STRINGS[44/*"t"*/], ::STRINGS[40/*"u"*/], ::STRINGS[45/*"v"*/], ::STRINGS[70/*"y"*/]));
    FuseDrawingPrimitives_bundle::Circlecfb305c9_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[71/*"uniform vec...*/], ::STRINGS[72/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 20, ::STRINGS[2/*"b"*/], ::STRINGS[3/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[18/*"r"*/], ::STRINGS[43/*"s"*/], ::STRINGS[45/*"v"*/]));
    FuseDrawingPrimitives_bundle::Circlecfb305ca_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[68/*"uniform vec...*/], ::STRINGS[73/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 23, ::STRINGS[2/*"b"*/], ::STRINGS[3/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[18/*"r"*/], ::STRINGS[43/*"s"*/], ::STRINGS[44/*"t"*/], ::STRINGS[40/*"u"*/], ::STRINGS[45/*"v"*/], ::STRINGS[70/*"y"*/]));
    ...
    FuseDrawingPrimitives_bundle::Circled802ead9_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[62/*"uniform vec...*/], ::STRINGS[76/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/]));
    ...
    FuseDrawingPrimitives_bundle::Circleef203ac7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[59/*"uniform vec...*/], ::STRINGS[80/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 15, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/]));
    ...
    FuseDrawingPrimitives_bundle::Rectangle7c95c5e3_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[91/*"uniform flo...*/], ::STRINGS[92/*"uniform vec...*/], 2, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 22, ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[18/*"r"*/], ::STRINGS[43/*"s"*/], ::STRINGS[44/*"t"*/], ::STRINGS[40/*"u"*/], ::STRINGS[93/*"z"*/]));
    FuseDrawingPrimitives_bundle::Rectangle7c95c5e4_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[91/*"uniform flo...*/], ::STRINGS[94/*"uniform vec...*/], 2, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 22, ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[18/*"r"*/], ::STRINGS[43/*"s"*/], ::STRINGS[44/*"t"*/], ::STRINGS[40/*"u"*/], ::STRINGS[93/*"z"*/]));
    ...
    FuseDrawingPrimitives_bundle::Rectanglea858f4fc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[101/*"uniform flo...*/], ::STRINGS[102/*"uniform vec...*/], 2, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 24, ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[18/*"r"*/], ::STRINGS[43/*"s"*/], ::STRINGS[44/*"t"*/], ::STRINGS[40/*"u"*/], ::STRINGS[45/*"v"*/], ::STRINGS[46/*"w"*/], ::STRINGS[103/*"B"*/]));
    FuseDrawingPrimitives_bundle::Rectanglea858f503_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[101/*"uniform flo...*/], ::STRINGS[104/*"uniform vec...*/], 2, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 24, ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[17/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[18/*"r"*/], ::STRINGS[43/*"s"*/], ::STRINGS[44/*"t"*/], ::STRINGS[40/*"u"*/], ::STRINGS[45/*"v"*/], ::STRINGS[46/*"w"*/], ::STRINGS[103/*"B"*/]));
...
{
    ::STRINGS[38] = uString::Const("uniform vec2 b,c,e,f,g,n;uniform mat4 d;uniform float o;attribute vec2 a;varying float s;varying vec2 t;vec4 v(vec2 x,mat4 y){return vec4(((x.x*y[0].x)+(x.y*y[1].x))+y[3].x,((x.x*y[0].y)+(x.y*y[1].y))+y[3].y,((x.x*y[0].z)+(x.y*y[1].z))+y[3].z,((x.x*y[0].w)+(x.y*y[1].w))+y[3].w);}float w(vec2 x,vec2 y,float z){vec2 A=(x*e)-f;float B=dot(A,y)/z;return (B-g.x)/g.y;}void main(){vec2 x=a*b;vec2 y=x+c;s=w(y/e,n,o);t=x;gl_Position=v(y,d);}");
    ::STRINGS[39] = uString::Const("uniform float h,i,j,k,l,m;uniform vec2 p,q,r;uniform sampler2D u;varying float s;varying vec2 t;void main(){vec4 x=texture2D(u,vec2(s,.5));vec4 y=vec4(x.xyz,x.w*(clamp(.5-(((abs((length(t)-h)-i)-j)*k)*l),float(0),float(1))*clamp(.5-((min(dot(t,p),min(dot(t,q),dot(t,r)))*k)*l),float(0),float(1))));gl_FragColor=vec4((y.xyz*y.w)*m,y.w*m);}");
    ::STRINGS[3] = uString::Const("a");
    ::STRINGS[2] = uString::Const("b");
    ::STRINGS[4] = uString::Const("c");
    ::STRINGS[5] = uString::Const("d");
    ...
    ::STRINGS[52] = uString::Const("uniform float h,i,j,k;uniform sampler2D p;varying float n;varying vec2 o;void main(){vec4 s=texture2D(p,vec2(n,.5));vec4 t=vec4(s.xyz,s.w*(clamp(.5-(((length(o)-h)*i)*j),float(0),float(1))*float(1)));gl_FragColor=vec4((t.xyz*t.w)*k,t.w*k);}");
    ::STRINGS[53] = uString::Const("uniform float h,i,j,k;uniform vec2 n,o,p;uniform sampler2D s;varying float q;varying vec2 r;void main(){vec4 v=texture2D(s,vec2(q,.5));vec4 w=vec4(v.xyz,v.w*(clamp(.5-(((length(r)-h)*i)*j),float(0),float(1))*clamp(.5-((min(dot(r,n),min(dot(r,o),dot(r,p)))*i)*j),float(0),float(1))));gl_FragColor=vec4((w.xyz*w.w)*k,w.w*k);}");
    ::STRINGS[54] = uString::Const("uniform float h,i,j,k,l,m;uniform vec2 p,q,r;uniform sampler2D u;varying float s;varying vec2 t;void main(){vec4 x=texture2D(u,vec2(s,.5));vec4 y=vec4(x.xyz,x.w*(clamp(.5-(((abs((length(t)-h)-i)-j)*k)*l),float(0),float(1))*clamp(.5-((max(dot(t,p),max(dot(t,q),dot(t,r)))*k)*l),float(0),float(1))));gl_FragColor=vec4((y.xyz*y.w)*m,y.w*m);}");
    ::STRINGS[55] = uString::Const("uniform vec2 b,c,e,f,g,n;uniform mat4 d;uniform float o;attribute vec2 a;varying float p;varying vec2 q;vec4 s(vec2 u,mat4 v){return vec4(((u.x*v[0].x)+(u.y*v[1].x))+v[3].x,((u.x*v[0].y)+(u.y*v[1].y))+v[3].y,((u.x*v[0].z)+(u.y*v[1].z))+v[3].z,((u.x*v[0].w)+(u.y*v[1].w))+v[3].w);}float t(vec2 u,vec2 v,float w){vec2 x=(u*e)-f;float y=dot(x,v)/w;return (y-g.x)/g.y;}void main(){vec2 u=a*b;vec2 v=u+c;p=t(v/e,n,o);q=u;gl_Position=s(v,d);}");
    ::STRINGS[56] = uString::Const("uniform float h,i,j,k,l,m;uniform sampler2D r;varying float p;varying vec2 q;void main(){vec4 u=texture2D(r,vec2(p,.5));vec4 v=vec4(u.xyz,u.w*(clamp(.5-(((abs((length(q)-h)-i)-j)*k)*l),float(0),float(1))*float(1)));gl_FragColor=vec4((v.xyz*v.w)*m,v.w*m);}");
    ::STRINGS[57] = uString::Const("uniform vec2 b,c;uniform mat4 d;attribute vec2 a;varying vec2 l;vec4 m(vec2 n,mat4 o){return vec4(((n.x*o[0].x)+(n.y*o[1].x))+o[3].x,((n.x*o[0].y)+(n.y*o[1].y))+o[3].y,((n.x*o[0].z)+(n.y*o[1].z))+o[3].z,((n.x*o[0].w)+(n.y*o[1].w))+o[3].w);}void main(){vec2 n=a*b;l=n;gl_Position=m(n+c,d);}");
    ::STRINGS[58] = uString::Const("uniform float e,f,g,h,i,j;uniform vec3 k;varying vec2 l;void main(){vec4 n=vec4(k,j*(clamp(.5-(((abs((length(l)-e)-f)-g)*h)*i),float(0),float(1))*float(1)));gl_FragColor=vec4((n.xyz*n.w)*1.,n.w);}");
    ::STRINGS[59] = uString::Const("uniform vec2 b,c;uniform mat4 d;attribute vec2 a;varying vec2 p;vec4 q(vec2 r,mat4 s){return vec4(((r.x*s[0].x)+(r.y*s[1].x))+s[3].x,((r.x*s[0].y)+(r.y*s[1].y))+s[3].y,((r.x*s[0].z)+(r.y*s[1].z))+s[3].z,((r.x*s[0].w)+(r.y*s[1].w))+s[3].w);}void main(){vec2 r=a*b;p=r;gl_Position=q(r+c,d);}");
    ::STRINGS[60] = uString::Const("uniform float e,f,g,h,i,j,l;uniform vec2 m,n,o;uniform vec3 k;varying vec2 p;void main(){vec4 r=vec4(k,j*(clamp(.5-(((abs((length(p)-e)-f)-g)*h)*i),float(0),float(1))*clamp(.5-((min(dot(p,m),min(dot(p,n),dot(p,o)))*h)*i),float(0),float(1))));gl_FragColor=vec4((r.xyz*r.w)*l,r.w*l);}");
    ::STRINGS[61] = uString::Const("uniform vec2 n,m,v,w,x;uniform vec4 o;uniform float p,q,r,s,t,u;uniform sampler2D A;varying vec2 y,z;void main(){vec4 C=(b?vec4(float(0)):texture2D(A,n+(fract(y)*m)))*o;vec4 D=vec4(C.xyz,C.w*(clamp(.5-(((abs((length(z)-p)-q)-r)*s)*t),float(0),float(1))*clamp(.5-((max(dot(z,v),max(dot(z,w),dot(z,x)))*s)*t),float(0),float(1))));gl_FragColor=vec4((D.xyz*D.w)*u,D.w*u);}");
    ::STRINGS[62] = uString::Const("uniform vec2 b,c;uniform mat4 d;attribute vec2 a;varying vec2 o;vec4 p(vec2 q,mat4 r){return vec4(((q.x*r[0].x)+(q.y*r[1].x))+r[3].x,((q.x*r[0].y)+(q.y*r[1].y))+r[3].y,((q.x*r[0].z)+(q.y*r[1].z))+r[3].z,((q.x*r[0].w)+(q.y*r[1].w))+r[3].w);}void main(){vec2 q=a*b;o=q;gl_Position=p(q+c,d);}");
    ::STRINGS[63] = uString::Const("uniform float e,f,g,h,i,j;uniform vec2 l,m,n;uniform vec3 k;varying vec2 o;void main(){vec4 q=vec4(k,j*(clamp(.5-(((abs((length(o)-e)-f)-g)*h)*i),float(0),float(1))*clamp(.5-((min(dot(o,l),min(dot(o,m),dot(o,n)))*h)*i),float(0),float(1))));gl_FragColor=vec4((q.xyz*q.w)*1.,q.w);}");
    ::STRINGS[64] = uString::Const("uniform vec2 b,c;uniform mat4 d;attribute vec2 a;varying vec2 m;vec4 n(vec2 o,mat4 p){return vec4(((o.x*p[0].x)+(o.y*p[1].x))+p[3].x,((o.x*p[0].y)+(o.y*p[1].y))+p[3].y,((o.x*p[0].z)+(o.y*p[1].z))+p[3].z,((o.x*p[0].w)+(o.y*p[1].w))+p[3].w);}void main(){vec2 o=a*b;m=o;gl_Position=n(o+c,d);}");
    ::STRINGS[65] = uString::Const("uniform float e,f,g,h,i,j,l;uniform vec3 k;varying vec2 m;void main(){vec4 o=vec4(k,j*(clamp(.5-(((abs((length(m)-e)-f)-g)*h)*i),float(0),float(1))*float(1)));gl_FragColor=vec4((o.xyz*o.w)*l,o.w*l);}");
    ...
    ::STRINGS[67] = uString::Const("uniform vec2 n,m;uniform vec4 o;uniform float p,q,r,s,t,u;uniform sampler2D x;varying vec2 v,w;void main(){vec4 z=(b?vec4(float(0)):texture2D(x,n+(fract(v)*m)))*o;vec4 A=vec4(z.xyz,z.w*(clamp(.5-(((abs((length(w)-p)-q)-r)*s)*t),float(0),float(1))*float(1)));gl_FragColor=vec4((A.xyz*A.w)*u,A.w*u);}");
    ...
    ::STRINGS[69] = uString::Const("uniform vec2 n,m,t,u,v;uniform vec4 o;uniform float p,q,r,s;uniform sampler2D y;varying vec2 w,x;void main(){vec4 A=(b?vec4(float(0)):texture2D(y,n+(fract(w)*m)))*o;vec4 B=vec4(A.xyz,A.w*(clamp(.5-(((length(x)-p)*q)*r),float(0),float(1))*clamp(.5-((min(dot(x,t),min(dot(x,u),dot(x,v)))*q)*r),float(0),float(1))));gl_FragColor=vec4((B.xyz*B.w)*s,B.w*s);}");
    ::STRINGS[70] = uString::Const("y");
    ::STRINGS[71] = uString::Const("uniform vec2 c,d,f,g,h,i,j,l,k;uniform mat4 e;attribute vec2 a;varying vec2 t,u;vec4 w(vec2 x,mat4 y){return vec4(((x.x*y[0].x)+(x.y*y[1].x))+y[3].x,((x.x*y[0].y)+(x.y*y[1].y))+y[3].y,((x.x*y[0].z)+(x.y*y[1].z))+y[3].z,((x.x*y[0].w)+(x.y*y[1].w))+y[3].w);}void main(){vec2 x=a*c;vec2 y=x+d;t=l+((((((f*(y/f))-g)/h)*i)+j)*k);u=x;gl_Position=w(y,e);}");
    ::STRINGS[72] = uString::Const("uniform vec2 n,m;uniform vec4 o;uniform float p,q,r,s;uniform sampler2D v;varying vec2 t,u;void main(){vec4 x=(b?vec4(float(0)):texture2D(v,n+(fract(t)*m)))*o;vec4 y=vec4(x.xyz,x.w*(clamp(.5-(((length(u)-p)*q)*r),float(0),float(1))*float(1)));gl_FragColor=vec4((y.xyz*y.w)*s,y.w*s);}");
    ::STRINGS[73] = uString::Const("uniform vec2 n,m,t,u,v;uniform vec4 o;uniform float p,q,r,s;uniform sampler2D y;varying vec2 w,x;void main(){vec4 A=(b?vec4(float(0)):texture2D(y,n+(fract(w)*m)))*o;vec4 B=vec4(A.xyz,A.w*(clamp(.5-(((length(x)-p)*q)*r),float(0),float(1))*clamp(.5-((max(dot(x,t),max(dot(x,u),dot(x,v)))*q)*r),float(0),float(1))));gl_FragColor=vec4((B.xyz*B.w)*s,B.w*s);}");
    ::STRINGS[74] = uString::Const("uniform vec2 b,c;uniform mat4 d;attribute vec2 a;varying vec2 k;vec4 l(vec2 m,mat4 n){return vec4(((m.x*n[0].x)+(m.y*n[1].x))+n[3].x,((m.x*n[0].y)+(m.y*n[1].y))+n[3].y,((m.x*n[0].z)+(m.y*n[1].z))+n[3].z,((m.x*n[0].w)+(m.y*n[1].w))+n[3].w);}void main(){vec2 m=a*b;k=m;gl_Position=l(m+c,d);}");
    ::STRINGS[75] = uString::Const("uniform float e,f,g,h,j;uniform vec3 i;varying vec2 k;void main(){vec4 m=vec4(i,h*(clamp(.5-(((length(k)-e)*f)*g),float(0),float(1))*float(1)));gl_FragColor=vec4((m.xyz*m.w)*j,m.w*j);}");
    ::STRINGS[76] = uString::Const("uniform float e,f,g,h,i,j;uniform vec2 l,m,n;uniform vec3 k;varying vec2 o;void main(){vec4 q=vec4(k,j*(clamp(.5-(((abs((length(o)-e)-f)-g)*h)*i),float(0),float(1))*clamp(.5-((max(dot(o,l),max(dot(o,m),dot(o,n)))*h)*i),float(0),float(1))));gl_FragColor=vec4((q.xyz*q.w)*1.,q.w);}");
    ...
    ::STRINGS[78] = uString::Const("uniform float e,f,g,h,j;uniform vec2 k,l,m;uniform vec3 i;varying vec2 n;void main(){vec4 p=vec4(i,h*(clamp(.5-(((length(n)-e)*f)*g),float(0),float(1))*clamp(.5-((max(dot(n,k),max(dot(n,l),dot(n,m)))*f)*g),float(0),float(1))));gl_FragColor=vec4((p.xyz*p.w)*j,p.w*j);}");
    ::STRINGS[79] = uString::Const("uniform float e,f,g,h,j;uniform vec2 k,l,m;uniform vec3 i;varying vec2 n;void main(){vec4 p=vec4(i,h*(clamp(.5-(((length(n)-e)*f)*g),float(0),float(1))*clamp(.5-((min(dot(n,k),min(dot(n,l),dot(n,m)))*f)*g),float(0),float(1))));gl_FragColor=vec4((p.xyz*p.w)*j,p.w*j);}");
    ::STRINGS[80] = uString::Const("uniform float e,f,g,h,i,j,l;uniform vec2 m,n,o;uniform vec3 k;varying vec2 p;void main(){vec4 r=vec4(k,j*(clamp(.5-(((abs((length(p)-e)-f)-g)*h)*i),float(0),float(1))*clamp(.5-((max(dot(p,m),max(dot(p,n),dot(p,o)))*h)*i),float(0),float(1))));gl_FragColor=vec4((r.xyz*r.w)*l,r.w*l);}");
    ::STRINGS[81] = uString::Const("uniform vec2 b,c;uniform mat4 d;attribute vec2 a;varying vec2 j;vec4 k(vec2 l,mat4 m){return vec4(((l.x*m[0].x)+(l.y*m[1].x))+m[3].x,((l.x*m[0].y)+(l.y*m[1].y))+m[3].y,((l.x*m[0].z)+(l.y*m[1].z))+m[3].z,((l.x*m[0].w)+(l.y*m[1].w))+m[3].w);}void main(){vec2 l=a*b;j=l;gl_Position=k(l+c,d);}");
    ::STRINGS[82] = uString::Const("uniform float e,f,g,h;uniform vec3 i;varying vec2 j;void main(){vec4 l=vec4(i,h*(clamp(.5-(((length(j)-e)*f)*g),float(0),float(1))*float(1)));gl_FragColor=vec4((l.xyz*l.w)*1.,l.w);}");
    ::STRINGS[83] = uString::Const("uniform float e,f,g,h;uniform vec2 j,k,l;uniform vec3 i;varying vec2 m;void main(){vec4 o=vec4(i,h*(clamp(.5-(((length(m)-e)*f)*g),float(0),float(1))*clamp(.5-((min(dot(m,j),min(dot(m,k),dot(m,l)))*f)*g),float(0),float(1))));gl_FragColor=vec4((o.xyz*o.w)*1.,o.w);}");
    ::STRINGS[84] = uString::Const("uniform float e,f,g,h;uniform vec2 j,k,l;uniform vec3 i;varying vec2 m;void main(){vec4 o=vec4(i,h*(clamp(.5-(((length(m)-e)*f)*g),float(0),float(1))*clamp(.5-((max(dot(m,j),max(dot(m,k),dot(m,l)))*f)*g),float(0),float(1))));gl_FragColor=vec4((o.xyz*o.w)*1.,o.w);}");
    ::STRINGS[85] = uString::Const("uniform float e[d],o;uniform vec2 f,h,i,j,n;uniform mat4 g;attribute vec4 a,b;attribute float c;varying float p,q;varying vec2 r,s;vec4 u(vec2 w,mat4 x){return vec4(((w.x*x[0].x)+(w.y*x[1].x))+x[3].x,((w.x*x[0].y)+(w.y*x[1].y))+x[3].y,((w.x*x[0].z)+(w.y*x[1].z))+x[3].z,((w.x*x[0].w)+(w.y*x[1].w))+x[3].w);}float v(vec2 w,vec2 x,float y){vec2 z=(w*h)-i;float A=dot(z,x)/y;return (A-j.x)/j.y;}void main(){vec2 w=vec2((sign(a.x)*e[int(abs(a.x))])+(sign(a.y)*e[int(abs(a.y))]),(sign(a.z)*e[int(abs(a.z))])+(sign(a.w)*e[int(abs(a.w))]))+f;p=e[int(c)];q=v(w/h,n,o);r=w;s=vec2((sign(b.x)*e[int(abs(b.x))])+(sign(b.y)*e[int(abs(b.y))]),(sign(b.z)*e[int(abs(b.z))])+(sign(b.w)*e[int(abs(b.w))]))+f;gl_Position=u(w,g);}");
    ::STRINGS[86] = uString::Const("uniform float k,l,m;uniform sampler2D t;varying float p,q;varying vec2 r,s;void main(){vec4 w=texture2D(t,vec2(q,.5));vec4 x=vec4(w.xyz,w.w*clamp(.5-(((distance(r,s)-p)*k)*l),float(0),float(1)));gl_FragColor=vec4((x.xyz*x.w)*m,x.w*m);}");
    ::STRINGS[87] = uString::Const("uniform float k,l,m;uniform sampler2D t;varying float p,q;varying vec2 r,s;void main(){vec4 w=texture2D(t,vec2(q,.5));float x=clamp(.5-(((distance(r,s)-p)*k)*l),float(0),float(1));vec4 y=vec4(w.xyz,w.w*(((x*x)*x)*((x*((x*float(6))-float(15)))+float(10))));gl_FragColor=vec4((y.xyz*y.w)*m,y.w*m);}");
    ::STRINGS[88] = uString::Const("uniform float e[d];uniform vec2 f;uniform mat4 g;attribute vec4 a,b;attribute float c;varying float l;varying vec2 m,n;vec4 o(vec2 p,mat4 q){return vec4(((p.x*q[0].x)+(p.y*q[1].x))+q[3].x,((p.x*q[0].y)+(p.y*q[1].y))+q[3].y,((p.x*q[0].z)+(p.y*q[1].z))+q[3].z,((p.x*q[0].w)+(p.y*q[1].w))+q[3].w);}void main(){vec2 p=vec2((sign(a.x)*e[int(abs(a.x))])+(sign(a.y)*e[int(abs(a.y))]),(sign(a.z)*e[int(abs(a.z))])+(sign(a.w)*e[int(abs(a.w))]))+f;l=e[int(c)];m=p;n=vec2((sign(b.x)*e[int(abs(b.x))])+(sign(b.y)*e[int(abs(b.y))]),(sign(b.z)*e[int(abs(b.z))])+(sign(b.w)*e[int(abs(b.w))]))+f;gl_Position=o(p,g);}");
    ::STRINGS[89] = uString::Const("uniform float h,i,j;uniform vec3 k;varying float l;varying vec2 m,n;void main(){vec4 p=vec4(k,j*clamp(.5-(((distance(m,n)-l)*h)*i),float(0),float(1)));gl_FragColor=vec4((p.xyz*p.w)*1.,p.w);}");
    ::STRINGS[90] = uString::Const("uniform float h,i,j;uniform vec3 k;varying float l;varying vec2 m,n;void main(){float p=clamp(.5-(((distance(m,n)-l)*h)*i),float(0),float(1));vec4 q=vec4(k,j*(((p*p)*p)*((p*((p*float(6))-float(15)))+float(10))));gl_FragColor=vec4((q.xyz*q.w)*1.,q.w);}");
    ::STRINGS[91] = uString::Const("uniform float f[d];uniform vec2 g,i,j,k,l,m,o,n;uniform mat4 h;attribute vec4 a,b;attribute float c;varying float v;varying vec2 w,x,y;vec4 A(vec2 B,mat4 C){return vec4(((B.x*C[0].x)+(B.y*C[1].x))+C[3].x,((B.x*C[0].y)+(B.y*C[1].y))+C[3].y,((B.x*C[0].z)+(B.y*C[1].z))+C[3].z,((B.x*C[0].w)+(B.y*C[1].w))+C[3].w);}void main(){vec2 B=vec2((sign(a.x)*f[int(abs(a.x))])+(sign(a.y)*f[int(abs(a.y))]),(sign(a.z)*f[int(abs(a.z))])+(sign(a.w)*f[int(abs(a.w))]))+g;v=f[int(c)];w=o+((((((i*(B/i))-j)/k)*l)+m)*n);x=B;y=vec2((sign(b.x)*f[int(abs(b.x))])+(sign(b.y)*f[int(abs(b.y))]),(sign(b.z)*f[int(abs(b.z))])+(sign(b.w)*f[int(abs(b.w))]))+g;gl_Position=A(B,h);}");
    ::STRINGS[92] = uString::Const("uniform vec2 q,p;uniform vec4 r;uniform float s,t,u;uniform sampler2D z;varying float v;varying vec2 w,x,y;void main(){vec4 B=(e?vec4(float(0)):texture2D(z,q+(fract(w)*p)))*r;vec4 C=vec4(B.xyz,B.w*clamp(.5-(((distance(x,y)-v)*s)*t),float(0),float(1)));gl_FragColor=vec4((C.xyz*C.w)*u,C.w*u);}");
    ::STRINGS[93] = uString::Const("z");
    ::STRINGS[94] = uString::Const("uniform vec2 q,p;uniform vec4 r;uniform float s,t,u;uniform sampler2D z;varying float v;varying vec2 w,x,y;void main(){vec4 B=(e?vec4(float(0)):texture2D(z,q+(fract(w)*p)))*r;float C=clamp(.5-(((distance(x,y)-v)*s)*t),float(0),float(1));vec4 D=vec4(B.xyz,B.w*(((C*C)*C)*((C*((C*float(6))-float(15)))+float(10))));gl_FragColor=vec4((D.xyz*D.w)*u,D.w*u);}");
    ::STRINGS[95] = uString::Const("uniform float e[d];uniform vec2 f;uniform mat4 g;attribute vec4 a,b;attribute float c;varying float n;varying vec2 o,p;vec4 q(vec2 r,mat4 s){return vec4(((r.x*s[0].x)+(r.y*s[1].x))+s[3].x,((r.x*s[0].y)+(r.y*s[1].y))+s[3].y,((r.x*s[0].z)+(r.y*s[1].z))+s[3].z,((r.x*s[0].w)+(r.y*s[1].w))+s[3].w);}void main(){vec2 r=vec2((sign(a.x)*e[int(abs(a.x))])+(sign(a.y)*e[int(abs(a.y))]),(sign(a.z)*e[int(abs(a.z))])+(sign(a.w)*e[int(abs(a.w))]))+f;n=e[int(c)];o=r;p=vec2((sign(b.x)*e[int(abs(b.x))])+(sign(b.y)*e[int(abs(b.y))]),(sign(b.z)*e[int(abs(b.z))])+(sign(b.w)*e[int(abs(b.w))]))+f;gl_Position=q(r,g);}");
    ::STRINGS[96] = uString::Const("uniform float h,i,j,k,l;uniform vec3 m;varying float n;varying vec2 o,p;void main(){vec4 r=vec4(m,l*clamp(.5-(((abs((distance(o,p)-n)-h)-i)*j)*k),float(0),float(1)));gl_FragColor=vec4((r.xyz*r.w)*1.,r.w);}");
    ::STRINGS[97] = uString::Const("uniform float e[d];uniform vec2 f;uniform mat4 g;attribute vec4 a,b;attribute float c;varying float m;varying vec2 n,o;vec4 p(vec2 q,mat4 r){return vec4(((q.x*r[0].x)+(q.y*r[1].x))+r[3].x,((q.x*r[0].y)+(q.y*r[1].y))+r[3].y,((q.x*r[0].z)+(q.y*r[1].z))+r[3].z,((q.x*r[0].w)+(q.y*r[1].w))+r[3].w);}void main(){vec2 q=vec2((sign(a.x)*e[int(abs(a.x))])+(sign(a.y)*e[int(abs(a.y))]),(sign(a.z)*e[int(abs(a.z))])+(sign(a.w)*e[int(abs(a.w))]))+f;m=e[int(c)];n=q;o=vec2((sign(b.x)*e[int(abs(b.x))])+(sign(b.y)*e[int(abs(b.y))]),(sign(b.z)*e[int(abs(b.z))])+(sign(b.w)*e[int(abs(b.w))]))+f;gl_Position=p(q,g);}");
    ::STRINGS[98] = uString::Const("uniform float h,i,j,l;uniform vec3 k;varying float m;varying vec2 n,o;void main(){vec4 q=vec4(k,j*clamp(.5-(((distance(n,o)-m)*h)*i),float(0),float(1)));gl_FragColor=vec4((q.xyz*q.w)*l,q.w*l);}");
    ::STRINGS[99] = uString::Const("uniform float h,i,j,l;uniform vec3 k;varying float m;varying vec2 n,o;void main(){float q=clamp(.5-(((distance(n,o)-m)*h)*i),float(0),float(1));vec4 r=vec4(k,j*(((q*q)*q)*((q*((q*float(6))-float(15)))+float(10))));gl_FragColor=vec4((r.xyz*r.w)*l,r.w*l);}");
    ::STRINGS[100] = uString::Const("uniform float h,i,j,k,l;uniform vec3 m;varying float n;varying vec2 o,p;void main(){float r=clamp(.5-(((abs((distance(o,p)-n)-h)-i)*j)*k),float(0),float(1));vec4 s=vec4(m,l*(((r*r)*r)*((r*((r*float(6))-float(15)))+float(10))));gl_FragColor=vec4((s.xyz*s.w)*1.,s.w);}");
    ::STRINGS[101] = uString::Const("uniform float f[d];uniform vec2 g,i,j,k,l,m,o,n;uniform mat4 h;attribute vec4 a,b;attribute float c;varying float x;varying vec2 y,z,A;vec4 C(vec2 D,mat4 E){return vec4(((D.x*E[0].x)+(D.y*E[1].x))+E[3].x,((D.x*E[0].y)+(D.y*E[1].y))+E[3].y,((D.x*E[0].z)+(D.y*E[1].z))+E[3].z,((D.x*E[0].w)+(D.y*E[1].w))+E[3].w);}void main(){vec2 D=vec2((sign(a.x)*f[int(abs(a.x))])+(sign(a.y)*f[int(abs(a.y))]),(sign(a.z)*f[int(abs(a.z))])+(sign(a.w)*f[int(abs(a.w))]))+g;x=f[int(c)];y=o+((((((i*(D/i))-j)/k)*l)+m)*n);z=D;A=vec2((sign(b.x)*f[int(abs(b.x))])+(sign(b.y)*f[int(abs(b.y))]),(sign(b.z)*f[int(abs(b.z))])+(sign(b.w)*f[int(abs(b.w))]))+g;gl_Position=C(D,h);}");
    ::STRINGS[102] = uString::Const("uniform vec2 q,p;uniform vec4 r;uniform float s,t,u,v,w;uniform sampler2D B;varying float x;varying vec2 y,z,A;void main(){vec4 D=(e?vec4(float(0)):texture2D(B,q+(fract(y)*p)))*r;float E=clamp(.5-(((abs((distance(z,A)-x)-s)-t)*u)*v),float(0),float(1));vec4 F=vec4(D.xyz,D.w*(((E*E)*E)*((E*((E*float(6))-float(15)))+float(10))));gl_FragColor=vec4((F.xyz*F.w)*w,F.w*w);}");
    ::STRINGS[103] = uString::Const("B");
    ::STRINGS[104] = uString::Const("uniform vec2 q,p;uniform vec4 r;uniform float s,t,u,v,w;uniform sampler2D B;varying float x;varying vec2 y,z,A;void main(){vec4 D=(e?vec4(float(0)):texture2D(B,q+(fract(y)*p)))*r;vec4 E=vec4(D.xyz,D.w*clamp(.5-(((abs((distance(z,A)-x)-s)-t)*u)*v),float(0),float(1)));gl_FragColor=vec4((E.xyz*E.w)*w,E.w*w);}");
    ...
    ::STRINGS[106] = uString::Const("uniform float h,i,j,k,l,n;uniform vec3 m;varying float o;varying vec2 p,q;void main(){float s=clamp(.5-(((abs((distance(p,q)-o)-h)-i)*j)*k),float(0),float(1));vec4 t=vec4(m,l*(((s*s)*s)*((s*((s*float(6))-float(15)))+float(10))));gl_FragColor=vec4((t.xyz*t.w)*n,t.w*n);}");
    ::STRINGS[107] = uString::Const("uniform float h,i,j,k,l,n;uniform vec3 m;varying float o;varying vec2 p,q;void main(){vec4 s=vec4(m,l*clamp(.5-(((abs((distance(p,q)-o)-h)-i)*j)*k),float(0),float(1)));gl_FragColor=vec4((s.xyz*s.w)*n,s.w*n);}");
    ::STRINGS[108] = uString::Const("uniform float e[d],q;uniform vec2 f,h,i,j,p;uniform mat4 g;attribute vec4 a,b;attribute float c;varying float r,s;varying vec2 t,u;vec4 w(vec2 y,mat4 z){return vec4(((y.x*z[0].x)+(y.y*z[1].x))+z[3].x,((y.x*z[0].y)+(y.y*z[1].y))+z[3].y,((y.x*z[0].z)+(y.y*z[1].z))+z[3].z,((y.x*z[0].w)+(y.y*z[1].w))+z[3].w);}float x(vec2 y,vec2 z,float A){vec2 B=(y*h)-i;float C=dot(B,z)/A;return (C-j.x)/j.y;}void main(){vec2 y=vec2((sign(a.x)*e[int(abs(a.x))])+(sign(a.y)*e[int(abs(a.y))]),(sign(a.z)*e[int(abs(a.z))])+(sign(a.w)*e[int(abs(a.w))]))+f;r=e[int(c)];s=x(y/h,p,q);t=y;u=vec2((sign(b.x)*e[int(abs(b.x))])+(sign(b.y)*e[int(abs(b.y))]),(sign(b.z)*e[int(abs(b.z))])+(sign(b.w)*e[int(abs(b.w))]))+f;gl_Position=w(y,g);}");
    ::STRINGS[109] = uString::Const("uniform float k,l,m,n,o;uniform sampler2D v;varying float r,s;varying vec2 t,u;void main(){vec4 y=texture2D(v,vec2(s,.5));vec4 z=vec4(y.xyz,y.w*clamp(.5-(((abs((distance(t,u)-r)-k)-l)*m)*n),float(0),float(1)));gl_FragColor=vec4((z.xyz*z.w)*o,z.w*o);}");
    ::STRINGS[110] = uString::Const("uniform float k,l,m,n,o;uniform sampler2D v;varying float r,s;varying vec2 t,u;void main(){vec4 y=texture2D(v,vec2(s,.5));float z=clamp(.5-(((abs((distance(t,u)-r)-k)-l)*m)*n),float(0),float(1));vec4 A=vec4(y.xyz,y.w*(((z*z)*z)*((z*((z*float(6))-float(15)))+float(10))));gl_FragColor=vec4((A.xyz*A.w)*o,A.w*o);}");
    ::TYPES[0] = ::g::Uno::String_typeof()->Array();
    type->SetFields(0,
...
{
    FuseEffects_bundle::Blitter6e650d31_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[111/*"uniform mat...*/], ::STRINGS[112/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[9/*"h"*/]));
    FuseEffects_bundle::Desaturate88bb7f94_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[113/*"uniform mat...*/], ::STRINGS[114/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[7/*"f"*/]));
    FuseEffects_bundle::EffectHelpers52052d40_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[115/*"attribute v...*/], ::STRINGS[116/*"uniform flo...*/], 3, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[3/*"a"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[9/*"h"*/]));
    FuseEffects_bundle::EffectHelpers9b892494_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[117/*"attribute v...*/], ::STRINGS[118/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[3/*"a"*/], ::STRINGS[4/*"c"*/]));
    ...
    FuseEffects_bundle::EffectHelperse7e608d1_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[121/*"uniform vec...*/], ::STRINGS[122/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 8, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[14/*"m"*/]));
    FuseEffects_bundle::Halftone3c4c510c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[123/*"uniform mat...*/], ::STRINGS[124/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[29/*"q"*/]));
    FuseEffects_bundle::Mask0da73af7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[125/*"uniform mat...*/], ::STRINGS[126/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/]));
    FuseEffects_bundle::Mask6affc65c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[125/*"uniform mat...*/], ::STRINGS[127/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/]));
    FuseEffects_bundle::Maskb04eaf92_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[125/*"uniform mat...*/], ::STRINGS[128/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/]));
}
...
{
    FuseElements_bundle::CacheHelper230c69b7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[129/*"uniform vec...*/], ::STRINGS[130/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[8/*"g"*/]));
    FuseElements_bundle::ElementBatchd43eeb4e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[131/*"uniform mat...*/], ::STRINGS[132/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[7/*"f"*/]));
    FuseElements_bundle::RepeatBaker447c61dc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[133/*"uniform vec...*/], ::STRINGS[134/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[6/*"e"*/]));
...
{
    FuseEntities_bundle::Blurc28c2aab_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[137/*"uniform vec...*/], ::STRINGS[138/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"h"*/]));
    ...
    FuseEntities_bundle::MeshRenderer9e110bf4_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[145/*"uniform mat...*/], ::STRINGS[146/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 3, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[4/*"c"*/]));
    FuseEntities_bundle::MeshRendererf90be5f8_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[147/*"uniform mat...*/], ::STRINGS[148/*"void main()...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[3/*"a"*/], ::STRINGS[2/*"b"*/]));
    FuseEntities_bundle::RenderToTexture8b784dd0_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[149/*"attribute v...*/], ::STRINGS[118/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[3/*"a"*/], ::STRINGS[4/*"c"*/]));
}
...
{
    FuseReactive_bundle::es6promised8269865_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[150/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[151/*"es6-promise...*/]);
    FuseReactive_bundle::Observable7c260f19_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[150/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[152/*"observable-...*/]);
}
