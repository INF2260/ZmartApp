...
// public static class GraphicsWorker :2810
// {
// static GraphicsWorker() :2810
...
static void GraphicsWorker_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.39.3/$.uno");
...
// private static extern ObjC.Object CreateContext() [static] :2835
...
// public static void Dispatch(Uno.Action a) [static] :2812
...
// public static void DispatchException() [static] :2871
...
// private static void OnWindowClosed(object sender, Uno.EventArgs args) [static] :2863
...
// private static void Run() [static] :2879
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            catch (const uThrowable& __t)
            {
                ...
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[1/*"GraphicsWor...*/], e, a, ::STRINGS[2/*"/usr/local/...*/], 2900, ::STRINGS[3/*"Run"*/]);
...
// private static extern void SetCurrentContext(ObjC.Object context) [static] :2841
...
// private static void Start() [static] :2846
