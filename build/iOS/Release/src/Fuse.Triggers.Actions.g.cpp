...
// /usr/local/share/uno/Packages/Fuse.Elements/0.39.3/triggers/actions/$.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.39.3/triggers/$.uno
// -----------------------------------------------------------------
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/0.39.3/$.uno");
    ::STRINGS[4] = uString::Const("Perform");
    ::TYPES[11] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[12] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[13] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[14] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[15] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    type->SetFields(8,
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/0.39.3/$.uno");
    ::STRINGS[4] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    ::g::Fuse::Controls::Navigator* nav = (n == NULL) ? uCast< ::g::Fuse::Controls::Navigator*>(NULL, ::TYPES[16/*Fuse.Controls.Navigator*/]) : uAs< ::g::Fuse::Controls::Navigator*>(uPtr(n)->Parent(), ::TYPES[16/*Fuse.Controls.Navigator*/]);
...
{
    ::TYPES[17] = ::g::Fuse::Triggers::Actions::IShow_typeof();
    type->SetFields(8);
}
...
{
    if (uIs(target, ::TYPES[17/*Fuse.Triggers.Actions.IShow*/]))
        ::g::Fuse::Triggers::Actions::IShow::Show(uInterface(uPtr((uObject*)target), ::TYPES[17/*Fuse.Triggers.Actions.IShow*/]));
}
// }
...
{
    ::TYPES[18] = ::g::Fuse::Triggers::Actions::IToggleable_typeof();
    type->SetFields(8,
...
void Toggle__Perform_fn(Toggle* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ::g::Fuse::Triggers::Actions::IToggleable::Toggle(uInterface(uPtr(t), ::TYPES[18/*Fuse.Triggers.Actions.IToggleable*/]));
}
...
uObject* Toggle::FindTarget(::g::Fuse::Node* n)
{
    while (n != NULL)
    {
        uObject* iv = uAs<uObject*>(n, ::TYPES[18/*Fuse.Triggers.Actions.IToggleable*/]);
...
{
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[20] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Controls::WebView_typeof());
    type->SetFields(8);
}
