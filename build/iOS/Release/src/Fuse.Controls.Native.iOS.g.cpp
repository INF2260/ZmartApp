...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/0.39.3/ios/$.uno
// -------------------------------------------------------------------

// internal sealed extern class FontCache :491
// {
...
// public static ObjC.Object GetFontFromFile(Uno.UX.FileSource fileSource, float fontSize) :496
...
// public static ObjC.Object GetFontFromFile(Uno.UX.FileSource fileSource, float fontSize) [static] :496
...
// internal abstract extern interface INativeFocusListener :348
// {
...
// internal sealed extern class iOSBlitter :1601
// {
// static iOSBlitter() :1601
...
// public generated iOSBlitter() :1601
void iOSBlitter__ctor__fn(iOSBlitter* __this)
{
    __this->ctor_();
}

// public void Blit(texture2D vt, float2 pos, float2 size, float4x4 localToClipTransform) :1605
...
// private generated void init_DrawCalls() :1601
void iOSBlitter__init_DrawCalls_fn(iOSBlitter* __this)
{
    __this->init_DrawCalls();
}

// public generated iOSBlitter New() :1601
...
// public generated iOSBlitter() [instance] :1601
void iOSBlitter::ctor_()
{
    init_DrawCalls();
}

// public void Blit(texture2D vt, float2 pos, float2 size, float4x4 localToClipTransform) [instance] :1605
...
// private generated void init_DrawCalls() [instance] :1601
...
// public generated iOSBlitter New() [static] :1601
...
// internal static extern class NativeFocus :354
// {
// static NativeFocus() :354
...
// public static void AddListener(ObjC.Object handle, Fuse.Controls.Native.iOS.INativeFocusListener listener) :360
void NativeFocus__AddListener_fn(uObject* handle, uObject* listener)
{
    NativeFocus::AddListener(handle, listener);
}

// public static void RaiseFocusGained(ObjC.Object handle) :370
void NativeFocus__RaiseFocusGained_fn(uObject* handle)
{
    NativeFocus::RaiseFocusGained(handle);
}

// public static void RaiseFocusLost(ObjC.Object handle) :378
void NativeFocus__RaiseFocusLost_fn(uObject* handle)
{
    NativeFocus::RaiseFocusLost(handle);
}

// public static void RemoveListener(ObjC.Object handle) :365
...
// public static void AddListener(ObjC.Object handle, Fuse.Controls.Native.iOS.INativeFocusListener listener) [static] :360
...
// public static void RaiseFocusGained(ObjC.Object handle) [static] :370
...
// public static void RaiseFocusLost(ObjC.Object handle) [static] :378
...
// public static void RemoveListener(ObjC.Object handle) [static] :365
...
// public sealed extern class OSVersion :1226
// {
...
// public OSVersion(int major, int minor, int patch) [instance] :1231
...
// public OSVersion New(int major, int minor, int patch) [static] :1231
...
// private sealed class FocusHelpers.PerformBecomeFirstResponder :465
// {
...
// public PerformBecomeFirstResponder New(ObjC.Object target) :469
...
// public PerformBecomeFirstResponder(ObjC.Object target) [instance] :469
void FocusHelpers__PerformBecomeFirstResponder::ctor_(uObject* target)
{
    _target = target;
}

// public void BecomeFirstResponder() [instance] :474
...
// public PerformBecomeFirstResponder New(ObjC.Object target) [static] :469
...
// public enum iOSDevice.ScreenOrientation :1246
...
// public enum UITouch.TouchPhase :1070
...
// public abstract extern class ViewParent :3542
// {
...
// protected ViewParent(ObjC.Object handle) :3544
void ViewParent__ctor_1_fn(ViewParent* __this, uObject* handle)
{
    __this->ctor_1(handle);
}

// protected ViewParent(ObjC.Object handle) [instance] :3544
