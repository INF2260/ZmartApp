...
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Over"*/]);
}

static void MainView__Template2_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Over");
    type->SetFields(2,
...
{
    ::g::Overview* self = ::g::Overview::New5(uPtr(__this->__parent1)->router);
