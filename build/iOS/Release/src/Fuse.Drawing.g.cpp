...
static void Brush_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing/0.39.3/$.uno");
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.39.3/drawing/$.uno
// ----------------------------------------------------------------

// public struct ImageFill.DrawParams :83
// {
...
// public Fuse.Drawing.ImageFill.DrawParams GetDrawParams(Fuse.DrawContext dc, float2 size) :143
...
// protected override sealed void OnPrepare(Fuse.DrawContext dc, float2 canvasSize) :95
void ImageFill__OnPrepare_fn(ImageFill* __this, ::g::Fuse::DrawContext* dc, ::g::Uno::Float2* canvasSize)
{
    ...
    if ((dp.Texture != NULL) && !uPtr(dp.Texture)->IsPow2())
    {
    ...
    else 
    {
        ...
        dp.SamplerState = ::g::Uno::Graphics::SamplerState__LinearWrap();
    }
...
// public Fuse.Resources.ImageSource get_Source() :195
void ImageFill__get_Source_fn(ImageFill* __this, ::g::Fuse::Resources::ImageSource** __retval)
{
    *__retval = __this->Source();
}

// public void set_Source(Fuse.Resources.ImageSource value) :196
...
// public float4 get_Color() [instance] :65
::g::Uno::Float4 ImageFill::Color()
{
    return _color;
}

// public void set_Color(float4 value) [instance] :66
...
// public Fuse.Drawing.ImageFill.DrawParams GetDrawParams(Fuse.DrawContext dc, float2 size) [instance] :143
ImageFill__DrawParams ImageFill::GetDrawParams(::g::Fuse::DrawContext* dc, ::g::Uno::Float2 size)
{
    return _drawParams;
}

// private float2 GetSize() [instance] :76
...
// public Fuse.Resources.ImageSource get_Source() [instance] :195
::g::Fuse::Resources::ImageSource* ImageFill::Source()
{
    return uPtr(_container)->Source();
}

// public void set_Source(Fuse.Resources.ImageSource value) [instance] :196
...
// internal sealed class RepeatBaker :236
// {
// static RepeatBaker() :236
...
// public generated RepeatBaker() :236
void RepeatBaker__ctor__fn(RepeatBaker* __this)
{
    __this->ctor_();
}

// public void FillBuffer(Fuse.DrawContext dc, texture2D tex, framebuffer fb) :240
...
// private generated void init_DrawCalls() :236
void RepeatBaker__init_DrawCalls_fn(RepeatBaker* __this)
{
    __this->init_DrawCalls();
}

// public generated RepeatBaker New() :236
...
// public generated RepeatBaker() [instance] :236
void RepeatBaker::ctor_()
{
    init_DrawCalls();
}

// public void FillBuffer(Fuse.DrawContext dc, texture2D tex, framebuffer fb) [instance] :240
...
// private generated void init_DrawCalls() [instance] :236
...
// public generated RepeatBaker New() [static] :236
