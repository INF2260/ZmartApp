...
static uType* TYPES[123];

namespace g{
namespace Fuse{

// /usr/local/share/uno/Packages/FuseCore/0.39.3/$.uno
// ---------------------------------------------------
...
static void Binding_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.39.3/$.uno");
...
// private sealed class Node.CallFuncClosure :4200
// {
...
// public CallFuncClosure(Fuse.Scripting.Function func, object arg) :4204
...
// public CallFuncClosure New(Fuse.Scripting.Function func, object arg) :4204
...
// public void Run() :4210
void Node__CallFuncClosure__Run_fn(Node__CallFuncClosure* __this)
{
    __this->Run();
}

// public CallFuncClosure(Fuse.Scripting.Function func, object arg) [instance] :4204
...
// public void Run() [instance] :4210
void Node__CallFuncClosure::Run()
{
    uPtr(_func)->Call(uArray::Init<uObject*>(::TYPES[10/*object[]*/], 1, (uObject*)_arg));
}

// public CallFuncClosure New(Fuse.Scripting.Function func, object arg) [static] :4204
...
// public enum Visual.CancelInteractionsType :5969
...
// internal sealed class DrawHelpers :5311
// {
...
// public generated DrawHelpers() :5311
void DrawHelpers__ctor__fn(DrawHelpers* __this)
{
    __this->ctor_();
}

// internal void DrawLocalRect(Fuse.DrawContext dc, Uno.Rect rect, float4x4 transform, float lineWidth, float4 color) :5325
...
// private generated void init_DrawCalls() :5311
void DrawHelpers__init_DrawCalls_fn(DrawHelpers* __this)
{
    __this->init_DrawCalls();
}

// public generated DrawHelpers New() :5311
void DrawHelpers__New1_fn(DrawHelpers** __retval)
{
    *__retval = DrawHelpers::New1();
}

// internal static Fuse.DrawHelpers get_Singelton() :5317
...
// public generated DrawHelpers() [instance] :5311
void DrawHelpers::ctor_()
{
    init_DrawCalls();
}

// internal void DrawLocalRect(Fuse.DrawContext dc, Uno.Rect rect, float4x4 transform, float lineWidth, float4 color) [instance] :5325
...
// private generated void init_DrawCalls() [instance] :5311
...
// public generated DrawHelpers New() [static] :5311
...
// internal static Fuse.DrawHelpers get_Singelton() [static] :5317
...
// public void AppendFastMatrix(Fuse.FastMatrix fm) [instance] :2391
...
// public void AppendRotation(float zRadians) [instance] :2274
...
// public void AppendRotationQuaternion(float4 q) [instance] :2348
...
// public void AppendScale(float factor) [instance] :2286
...
// public void AppendScale(float3 scale) [instance] :2342
...
// public void AppendShear(float xRadians, float yRadians) [instance] :2304
...
// public void AppendTranslation(float x, float y, float z) [instance] :2250
...
// public Fuse.FastMatrix Mul(Fuse.FastMatrix m) [instance] :2317
...
// public void PrependFastMatrix(Fuse.FastMatrix fm) [instance] :2376
...
// public void PrependRotation(float zRadians) [instance] :2280
...
// public void PrependRotationQuaternion(float4 q) [instance] :2365
...
// public void PrependScale(float factor) [instance] :2292
...
// public void PrependScale(float3 scale) [instance] :2359
...
// public void PrependShear(float xRadians, float yRadians) [instance] :2298
...
// public void PrependTranslation(float x, float y, float z) [instance] :2262
...
// public void PrependTranslation(float3 offset) [instance] :2371
...
// public void ResetIdentity() [instance] :2237
void FastMatrix::ResetIdentity()
{
    _matrix = ::g::Uno::Float4x4__Identity();
}

// private void SimpleTranslation(float x, float y, float z) [instance] :2310
...
// public static Fuse.FastMatrix FromFloat4x4(float4x4 m) [static] :2242
...
// public static Fuse.FastMatrix Identity() [static] :2230
FastMatrix* FastMatrix::Identity()
{
    return FastMatrix::New1();
}

// private FastMatrix New() [static] :2219
...
// private FastMatrix New(Fuse.FastMatrix orig) [static] :2224
...
// internal enum FastProperty1 :5447
...
// internal class FastProperty1Link :5489
// {
...
// public FastProperty1Link(Fuse.FastProperty1 p) :5494
void FastProperty1Link__ctor__fn(FastProperty1Link* __this, int* p)
{
    __this->ctor_(*p);
}

// public FastProperty1Link(Fuse.FastProperty1 p) [instance] :5494
...
// internal sealed class FastProperty1Link<T> :5500
// {
...
// public FastProperty1Link(Fuse.FastProperty1 p, T value) :5503
...
// public FastProperty1Link New(Fuse.FastProperty1 p, T value) :5503
...
// internal enum FastProperty2 :5620
...
// internal class FastProperty2Link :5642
// {
...
// public FastProperty2Link(Fuse.FastProperty2 p) :5647
void FastProperty2Link__ctor__fn(FastProperty2Link* __this, int* p)
{
    __this->ctor_(*p);
}

// public FastProperty2Link(Fuse.FastProperty2 p) [instance] :5647
...
// internal sealed class FastProperty2Link<T> :5653
// {
...
// public FastProperty2Link(Fuse.FastProperty2 p, T value) :5656
...
// public FastProperty2Link New(Fuse.FastProperty2 p, T value) :5656
...
// internal sealed class FixedViewport :3202
// {
...
// public FixedViewport(int2 pixelSize, float pixelsPerPoint, Fuse.IFrustum frustum) :3241
...
// public FixedViewport New(int2 pixelSize, float pixelsPerPoint, Fuse.IFrustum frustum) :3241
...
// public float4x4 get_ProjectionTransform() :3215
...
// public float4x4 get_ViewTransform() :3223
void FixedViewport__get_ViewTransform_fn(FixedViewport* __this, ::g::Uno::Float4x4* __retval)
{
    *__retval = __this->ViewTransform();
}

// public Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) :3234
...
// public FixedViewport(int2 pixelSize, float pixelsPerPoint, Fuse.IFrustum frustum) [instance] :3241
...
// public float2 get_PixelSize() [instance] :3210
::g::Uno::Float2 FixedViewport::PixelSize()
{
    return _pixelSize;
}

// public float get_PixelsPerPoint() [instance] :3205
float FixedViewport::PixelsPerPoint()
{
    return _pixelsPerPoint;
}

// public Uno.Geometry.Ray PointToWorldRay(float2 pointPos) [instance] :3230
...
// public float4x4 get_ViewProjectionTransform() [instance] :3219
::g::Uno::Float4x4 FixedViewport::ViewProjectionTransform()
{
    return uPtr(_frustumViewport)->ViewProjectionTransform;
}

// public float4x4 get_ViewTransform() [instance] :3223
::g::Uno::Float4x4 FixedViewport::ViewTransform()
{
    return uPtr(_frustumViewport)->ViewTransform;
}

// public Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) [instance] :3234
...
// public FixedViewport New(int2 pixelSize, float pixelsPerPoint, Fuse.IFrustum frustum) [static] :3241
...
// private enum LayoutParams.Flags :3300
...
// public Font(Uno.UX.FileSource file) [instance] :2485
void Font::ctor_(::g::Uno::UX::FileSource* file)
{
    _file = file;
}

// internal Uno.UX.FileSource get_File() [instance] :2441
::g::Uno::UX::FileSource* Font::File()
{
    return _file;
}

// public Font New(Uno.UX.FileSource file) [static] :2485
...
// public static Fuse.Font get_PlatformDefault() [static] :2497
Font* Font::PlatformDefault()
{
    Font_typeof()->Init();

    if (Font::_fallback() == NULL)
        Font::_fallback() = Font::New1(::g::Uno::UX::BundleFileSource::New1(::g::FuseCore_bundle::RobotoRegular1f08fa7e()));

    return Font::_fallback();
}

// public static float get_PlatformDefaultSize() [static] :2509
...
// public static float4 get_PlatformDefaultTextColor() [static] :2519
...
// public static class FramebufferPool :2540
// {
...
// private static void EnsurePool() :2544
void FramebufferPool__EnsurePool_fn()
{
    FramebufferPool::EnsurePool();
}

// internal static int get_Frame() :2576
void FramebufferPool__get_Frame_fn(int* __retval)
{
    *__retval = FramebufferPool::Frame();
}

// public static framebuffer Lock(int width, int height, Uno.Graphics.Format format, bool depth) :2562
...
// public static framebuffer Lock(int2 size, Uno.Graphics.Format format, bool depth) :2558
...
// private static void EnsurePool() [static] :2544
...
// public static framebuffer Lock(int width, int height, Uno.Graphics.Format format, bool depth) [static] :2562
...
// public static framebuffer Lock(int2 size, Uno.Graphics.Format format, bool depth) [static] :2558
...
// internal static void Register(Fuse.CacheFramebuffer cfb) [static] :2546
...
// public static void Release(framebuffer fb) [static] :2568
...
// internal static void UnRegister(Fuse.CacheFramebuffer cfb) [static] :2552
...
// internal static int get_Frame() [static] :2576
...
// internal sealed class FramebufferPoolImpl :2585
// {
...
// public FramebufferPoolImpl() :2587
void FramebufferPoolImpl__ctor__fn(FramebufferPoolImpl* __this)
{
    __this->ctor_();
}

// private void CollectCacheFramebuffers() :2674
void FramebufferPoolImpl__CollectCacheFramebuffers_fn(FramebufferPoolImpl* __this)
{
    __this->CollectCacheFramebuffers();
}

// private framebuffer FindBuffer(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) :2605
...
// private void Fuse.Resources.ISoftDisposable.SoftDispose() :2706
...
// internal framebuffer Lock(int width, int height, Uno.Graphics.Format format, bool depth) :2728
...
// private void CollectCacheFramebuffers() [instance] :2674
...
// private framebuffer FindBuffer(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) [instance] :2605
...
// internal framebuffer Lock(int width, int height, Uno.Graphics.Format format, bool depth) [instance] :2728
...
// internal void Register(Fuse.CacheFramebuffer cfb) [instance] :2646
...
// internal void Release(framebuffer fb) [instance] :2736
...
// internal void UnRegister(Fuse.CacheFramebuffer cfb) [instance] :2667
...
// public void Update() [instance] :2746
...
// public FramebufferPoolImpl New() [static] :2587
...
// internal sealed class FrustumViewport :3120
// {
...
// public generated FrustumViewport() :3120
void FrustumViewport__ctor__fn(FrustumViewport* __this)
{
    __this->ctor_();
}

// public static float2 LocalPlaneIntersection(Uno.Geometry.Ray local) :3193
...
// public generated FrustumViewport New() :3120
void FrustumViewport__New1_fn(FrustumViewport** __retval)
{
    *__retval = FrustumViewport::New1();
}

// public static Uno.Geometry.Ray PointToWorldRay(Fuse.IViewport viewport, float4x4 viewProjectionInverse, float2 pointPos) :3164
...
// public void Update(Fuse.IViewport viewport, Fuse.IFrustum frustum) :3129
void FrustumViewport__Update_fn(FrustumViewport* __this, uObject* viewport, uObject* frustum)
{
    __this->Update(viewport, frustum);
}

// public static Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport viewport, Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) :3179
...
// public generated FrustumViewport() [instance] :3120
void FrustumViewport::ctor_()
{
}

// public void Update(Fuse.IViewport viewport, Fuse.IFrustum frustum) [instance] :3129
...
// public static float2 LocalPlaneIntersection(Uno.Geometry.Ray local) [static] :3193
...
// public generated FrustumViewport New() [static] :3120
...
// public static Uno.Geometry.Ray PointToWorldRay(Fuse.IViewport viewport, float4x4 viewProjectionInverse, float2 pointPos) [static] :3164
...
// public static Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport viewport, Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) [static] :3179
...
// private sealed class TranslationModes.HeightMode :10138
// {
...
// public generated HeightMode() :10138
void TranslationModes__HeightMode__ctor_1_fn(TranslationModes__HeightMode* __this)
{
    __this->ctor_1();
}

// public override sealed float3 GetAbsVector(Fuse.Translation t) :10140
...
// public generated HeightMode New() :10138
...
// public generated HeightMode() [instance] :10138
void TranslationModes__HeightMode::ctor_1()
{
    ctor_();
}

// public generated HeightMode New() [static] :10138
...
// public delegate void HitTestCallback(Fuse.HitTestResult result) :2926
...
// public sealed class HitTestContext :2939
// {
...
// public HitTestContext(float2 windowPoint, Fuse.HitTestCallback callback) :3001
...
// public Uno.Geometry.Ray PushWorldRay(Uno.Geometry.Ray n) :2961
...
// public Fuse.HitTestCallback get_Callback() [instance] :2976
uDelegate* HitTestContext::Callback()
{
    return _callback;
}

// public void Dispose() [instance] :3008
void HitTestContext::Dispose()
{
    _callback = NULL;
}

// public void Hit(Fuse.Visual obj) [instance] :2979
...
// public void Hit(Fuse.Visual obj, float hitDistance) [instance] :2989
...
// public float2 get_LocalPoint() [instance] :2944
::g::Uno::Float2 HitTestContext::LocalPoint()
{
    return _localPoint;
}

// public void PopLocalPoint(float2 lp) [instance] :2953
void HitTestContext::PopLocalPoint(::g::Uno::Float2 lp)
{
    _localPoint = lp;
}

// public float2 PushLocalPoint(float2 lp) [instance] :2946
...
// public Uno.Geometry.Ray PushWorldRay(Uno.Geometry.Ray n) [instance] :2961
...
// public generated float2 get_WindowPoint() [instance] :2941
::g::Uno::Float2 HitTestContext::WindowPoint()
{
    return _WindowPoint;
}

// private generated void set_WindowPoint(float2 value) [instance] :2941
void HitTestContext::WindowPoint(::g::Uno::Float2 value)
{
    _WindowPoint = value;
}

// public Uno.Geometry.Ray get_WorldRay() [instance] :2959
::g::Uno::Geometry::Ray HitTestContext::WorldRay()
{
    return _worldRay;
}

// public HitTestContext New(float2 windowPoint, Fuse.HitTestCallback callback) [static] :3001
...
// private sealed class Visual.HitTestRecord :5846
// {
...
// public generated HitTestRecord() :5846
void Visual__HitTestRecord__ctor__fn(Visual__HitTestRecord* __this)
{
    __this->ctor_();
}

// public void HitTestCallback(Fuse.HitTestResult result) :5849
...
// public generated HitTestRecord New() :5846
void Visual__HitTestRecord__New1_fn(Visual__HitTestRecord** __retval)
{
    *__retval = Visual__HitTestRecord::New1();
}

// public generated HitTestRecord() [instance] :5846
void Visual__HitTestRecord::ctor_()
{
}

// public void HitTestCallback(Fuse.HitTestResult result) [instance] :5849
...
// public generated HitTestRecord New() [static] :5846
...
// public sealed class HitTestResult :2930
// {
...
// internal enum Visual.HitTestTransformMode :5777
...
// public abstract interface IActualPlacement :10056
// {
...
// public abstract interface IBeginRemoveVisualListener :4885
// {
...
// public abstract interface ICommonViewport :3042
// {
...
// internal abstract interface IDataProvider :7510
// {
...
// private sealed class ScalingModes.IdentityMode :9188
// {
...
// public generated IdentityMode() :9188
void ScalingModes__IdentityMode__ctor__fn(ScalingModes__IdentityMode* __this)
{
    __this->ctor_();
}

// public float3 GetScaleVector(Fuse.Scaling t) :9190
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) :9193
...
// public generated IdentityMode() [instance] :9188
void ScalingModes__IdentityMode::ctor_()
{
}

// public float3 GetScaleVector(Fuse.Scaling t) [instance] :9190
::g::Uno::Float3 ScalingModes__IdentityMode::GetScaleVector(::g::Fuse::Scaling* t)
{
    return uPtr(t)->Vector();
}

// public object Subscribe(Fuse.ITransformRelative transform) [instance] :9192
uObject* ScalingModes__IdentityMode::Subscribe(uObject* transform)
{
    return NULL;
}

// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :9193
void ScalingModes__IdentityMode::Unsubscribe(uObject* transform, uObject* sub)
{
}

// public generated IdentityMode New() [static] :9188
...
// public abstract interface IFrustum :3023
// {
...
// public abstract interface INameListener :9328
// {
...
// private struct Visual.InteractionItem :5923
// {
...
// public enum InvalidateLayoutReason :6308
...
// public abstract interface IParentObserver :4980
// {
...
// public abstract interface IRenderViewport :3070
// {
...
// public abstract interface IScalingMode :9181
// {
...
// public abstract interface ITemplateObserver :7425
// {
...
// public abstract interface ITransformMode :9868
// {
...
// public abstract interface ITransformRelative :9858
// {
...
// public abstract interface ITranslationMode :10063
// {
...
// public abstract interface IUpdateListener :10301
// {
...
// public abstract interface IViewport :3100
// {
...
// internal sealed class KeyboardBootstrapper :8918
// {
...
// public static void OnKeyPressed(object sender, Uno.Platform.KeyEventArgs args) :8920
...
// public static void OnKeyReleased(object sender, Uno.Platform.KeyEventArgs args) :8937
...
// public static void OnKeyPressed(object sender, Uno.Platform.KeyEventArgs args) [static] :8920
...
// public static void OnKeyReleased(object sender, Uno.Platform.KeyEventArgs args) [static] :8937
...
// public enum LayoutDependent :6316
...
// public struct LayoutParams :3298
// {
...
// private float2 PointConstrain(float2 p, bool knowX, bool knowY) :3619
...
// public void BoxConstrain(Fuse.LayoutParams o) [instance] :3604
...
// public Fuse.LayoutParams Clone() [instance] :3366
...
// public Fuse.LayoutParams CloneAndDerive() [instance] :3395
...
// public void ConstrainMax(float2 max, [bool hasMaxX], [bool hasMaxY]) [instance] :3561
...
// public void ConstrainMaxX(float max) [instance] :3543
...
// public void ConstrainMaxY(float max) [instance] :3552
...
// public void ConstrainMin(float2 min, [bool hasMinX], [bool hasMinY]) [instance] :3590
...
// public void ConstrainMinX(float min) [instance] :3572
...
// public void ConstrainMinY(float min) [instance] :3581
...
// public float2 GetAvailableSize() [instance] :3656
::g::Uno::Float2 LayoutParams::GetAvailableSize()
{
    return PointConstrain1(::g::Uno::Float2__New1(0.0f), false, false);
}

// public bool get_HasMaxSize() [instance] :3338
bool LayoutParams::HasMaxSize()
{
    return HasMaxX() && HasMaxY();
}

// public bool get_HasMaxX() [instance] :3336
bool LayoutParams::HasMaxX()
{
    return (_flags & 8) == 8;
}

// public bool get_HasMaxY() [instance] :3337
bool LayoutParams::HasMaxY()
{
    return (_flags & 16) == 16;
}

// public bool get_HasMinX() [instance] :3340
bool LayoutParams::HasMinX()
{
    return (_flags & 32) == 32;
}

// public bool get_HasMinY() [instance] :3341
bool LayoutParams::HasMinY()
{
    return (_flags & 64) == 64;
}

// public bool get_HasRelativeX() [instance] :3346
...
// public bool get_HasRelativeY() [instance] :3355
...
// public bool get_HasSize() [instance] :3332
bool LayoutParams::HasSize()
{
    return HasX() && HasY();
}

// public bool get_HasX() [instance] :3330
bool LayoutParams::HasX()
{
    return (_flags & 1) == 1;
}

// public bool get_HasY() [instance] :3331
bool LayoutParams::HasY()
{
    return (_flags & 2) == 2;
}

// public bool IsCompatible(Fuse.LayoutParams nlp) [instance] :3732
...
// public float2 get_MaxSize() [instance] :3665
::g::Uno::Float2 LayoutParams::MaxSize()
{
    return _maxSize;
}

// public float get_MaxX() [instance] :3666
float LayoutParams::MaxX()
{
    return _maxSize.X;
}

// public float get_MaxY() [instance] :3667
float LayoutParams::MaxY()
{
    return _maxSize.Y;
}

// public float2 get_MinSize() [instance] :3669
::g::Uno::Float2 LayoutParams::MinSize()
{
    return _minSize;
}

// public float get_MinX() [instance] :3670
float LayoutParams::MinX()
{
    return _minSize.X;
}

// public float get_MinY() [instance] :3671
float LayoutParams::MinY()
{
    return _minSize.Y;
}

// public float2 PointConstrain(float2 p) [instance] :3614
::g::Uno::Float2 LayoutParams::PointConstrain(::g::Uno::Float2 p)
{
    return PointConstrain1(p, true, true);
}

// private float2 PointConstrain(float2 p, bool knowX, bool knowY) [instance] :3619
...
// public float get_RelativeX() [instance] :3676
...
// public float get_RelativeY() [instance] :3685
...
// public void RemoveSize(float2 size) [instance] :3471
...
// public void RemoveSize(float4 size) [instance] :3478
...
// public void Reset() [instance] :3419
...
// public void RetainMaxXY(bool x, bool y) [instance] :3497
...
// public void RetainXY(bool x, bool y) [instance] :3483
...
// private void SetFlag(Fuse.LayoutParams.Flags g, bool val) [instance] :3322
...
// public void SetRelativeSize(float2 sz, bool hasX, bool hasY) [instance] :3534
...
// public void SetSize(float2 xy, [bool hasX], [bool hasY]) [instance] :3511
...
// public void SetX(float x) [instance] :3522
...
// public void SetY(float y) [instance] :3528
...
// public float2 get_Size() [instance] :3661
::g::Uno::Float2 LayoutParams::Size()
{
    return _size;
}

// public bool get_Temporary() [instance] :3334
bool LayoutParams::Temporary()
{
    return (_flags & 4) == 4;
}

// public float get_X() [instance] :3662
float LayoutParams::X()
{
    return _size.X;
}

// public float get_Y() [instance] :3663
float LayoutParams::Y()
{
    return _size.Y;
}

// public static Fuse.LayoutParams Create(float2 size) [static] :3434
...
// public static Fuse.LayoutParams CreateEmpty() [static] :3463
LayoutParams LayoutParams__CreateEmpty()
{
    return uDefault<LayoutParams>();
}

// public static Fuse.LayoutParams CreateTemporary(float2 size) [static] :3443
...
// public static Fuse.LayoutParams CreateXY(float2 size, bool hasX, bool hasY) [static] :3453
...
// public static class LayoutPriority :10294
// {
// static LayoutPriority() :10294
...
// private sealed class TranslationModes.LocalMode :10070
// {
...
// public generated LocalMode() :10070
void TranslationModes__LocalMode__ctor__fn(TranslationModes__LocalMode* __this)
{
    __this->ctor_();
}

// public float3 GetAbsVector(Fuse.Translation t) :10072
...
// internal sealed extern class MobileBootstrapping :3768
// {
...
// internal static void OnKeyReleased(object sender, Uno.Platform.KeyEventArgs args) :3806
...
// private static void OnReceivedLowMemoryWarning(object sender, Uno.EventArgs args) :3837
...
// private static void OnStarted(Uno.Platform2.ApplicationState state) :3811
void MobileBootstrapping__OnStarted_fn(int* state)
{
    MobileBootstrapping::OnStarted(*state);
}

// private static void OnTerminating(Uno.Platform2.ApplicationState state) :3790
...
// public static void Init() [static] :3771
...
// private static void OnEnterBackground(Uno.Platform2.ApplicationState state) [static] :3833
void MobileBootstrapping::OnEnterBackground(int state)
{
}

// private static void OnEnterForeground(Uno.Platform2.ApplicationState state) [static] :3816
void MobileBootstrapping::OnEnterForeground(int state)
{
    uPtr(::g::Uno::Platform2::Display::MainDisplay())->FramesPerSecond(20U);
}

// private static void OnEnterInteractive(Uno.Platform2.ApplicationState state) [static] :3821
...
// private static void OnExitInteractive(Uno.Platform2.ApplicationState state) [static] :3827
...
// internal static void OnKeyPressed(object sender, Uno.Platform.KeyEventArgs args) [static] :3801
...
// internal static void OnKeyReleased(object sender, Uno.Platform.KeyEventArgs args) [static] :3806
...
// private static void OnReceivedLowMemoryWarning(object sender, Uno.EventArgs args) [static] :3837
void MobileBootstrapping::OnReceivedLowMemoryWarning(uObject* sender, ::g::Uno::EventArgs* args)
{
}

// private static void OnStarted(Uno.Platform2.ApplicationState state) [static] :3811
void MobileBootstrapping::OnStarted(int state)
{
    uPtr(::g::Uno::Application::Current())->Load();
}

// private static void OnTerminating(Uno.Platform2.ApplicationState state) [static] :3790
...
// public static class NameRegistry :9334
// {
// static NameRegistry() :9334
...
// public static void AddListener(Uno.UX.Selector name, Fuse.INameListener listener) :9395
void NameRegistry__AddListener_fn(::g::Uno::UX::Selector* name, uObject* listener)
{
    NameRegistry::AddListener(*name, listener);
}

// public static void ClearName(Fuse.Node obj) :9388
void NameRegistry__ClearName_fn(::g::Fuse::Node* obj)
{
    NameRegistry::ClearName(obj);
}

// internal static Uno.Collections.List<Fuse.Node> GetObjectsWithName(Uno.UX.Selector name) :9375
...
// private static void NotifyNameChanged(Fuse.Node obj, Uno.UX.Selector name) :9417
void NameRegistry__NotifyNameChanged_fn(::g::Fuse::Node* obj, ::g::Uno::UX::Selector* name)
{
    NameRegistry::NotifyNameChanged(obj, *name);
}

// public static void RemoveListener(Fuse.INameListener listener) :9405
void NameRegistry__RemoveListener_fn(uObject* listener)
{
    NameRegistry::RemoveListener(listener);
}

// public static void SetName(Fuse.Node obj, Uno.UX.Selector name) :9340
...
// public static void AddListener(Uno.UX.Selector name, Fuse.INameListener listener) [static] :9395
...
// public static void ClearName(Fuse.Node obj) [static] :9388
...
// internal static Uno.Collections.List<Fuse.Node> GetObjectsWithName(Uno.UX.Selector name) [static] :9375
...
// private static void NotifyNameChanged(Fuse.Node obj, Uno.UX.Selector name) [static] :9417
...
// public static void RemoveListener(Fuse.INameListener listener) [static] :9405
...
// public static void SetName(Fuse.Node obj, Uno.UX.Selector name) [static] :9340
...
// public interfacemodifiers class Node :3867
// {
// static Node() :4192
...
// private Fuse.Scripting.Context Fuse.Scripting.IScriptObject.get_ScriptContext() :3879
...
// private object Fuse.Scripting.IScriptObject.get_ScriptObject() :3874
...
// private void Fuse.Scripting.IScriptObject.SetScriptObject(object obj, Fuse.Scripting.Context context) :3882
...
// private void Uno.Collections.ICollection<Fuse.Binding>.Clear() :4025
...
// private bool Uno.Collections.ICollection<Fuse.Binding>.Contains(Fuse.Binding item) :4050
...
// private int Uno.Collections.ICollection<Fuse.Binding>.get_Count() :4060
...
// private Uno.Collections.IEnumerator<Fuse.Binding> Uno.Collections.IEnumerable<Fuse.Binding>.GetEnumerator() :4118
...
// private Fuse.Binding Uno.Collections.IList<Fuse.Binding>.get_Item(int index) :4099
...
// private void Uno.Collections.IList<Fuse.Binding>.RemoveAt(int index) :4080
...
// protected generated Node() [instance] :3867
void Node::ctor_1()
{
...
// public void Add(Fuse.Binding item) [instance] :4031
...
// private Fuse.Binding get_Binding() [instance] :3979
::g::Fuse::Binding* Node::Binding()
{
    return uAs< ::g::Fuse::Binding*>(_bindings, ::TYPES[51/*Fuse.Binding*/]);
}

// private Uno.Collections.List<Fuse.Binding> get_BindingList() [instance] :3980
...
// public Uno.Collections.IList<Fuse.Binding> get_Bindings() [instance] :3975
uObject* Node::Bindings()
{
    return (uObject*)this;
}

// public Fuse.Node get_ContextParent() [instance] :3910
...
// public generated void add_DataContextChanged(Uno.EventHandler value) [instance] :4175
...
// public generated void remove_DataContextChanged(Uno.EventHandler value) [instance] :4175
...
// private int DistanceTo(Fuse.Node obj, int reference) [instance] :4336
...
// public Fuse.Node FindNodeByName(Uno.UX.Selector name, [Uno.Predicate<Fuse.Node> acceptor]) [instance] :4311
...
// public object GetFirstData() [instance] :4144
...
// private bool HasInSubtree(Fuse.Node c) [instance] :4352
...
// public void Insert(int index, Fuse.Binding item) [instance] :4068
...
// internal bool get_IsPreservedRootFrame() [instance] :4546
bool Node::IsPreservedRootFrame()
{
    return _preservedRootFrame == ::g::Fuse::UpdateManager::FrameIndex();
}

// public bool get_IsRootingCompleted() [instance] :4397
bool Node::IsRootingCompleted()
{
    return _rootStage == 2;
}

// public bool get_IsRootingStarted() [instance] :4392
bool Node::IsRootingStarted()
{
    return (_rootStage == 1) || (_rootStage == 2);
}

// internal bool get_IsUnrooting() [instance] :4399
bool Node::IsUnrooting()
{
    return _rootStage == 3;
}

// private void MakeBindingList(Fuse.Binding newItem) [instance] :3982
...
// public Uno.UX.Selector get_Name() [instance] :4289
::g::Uno::UX::Selector Node::Name()
{
    return _name;
}

// public void set_Name(Uno.UX.Selector value) [instance] :4290
...
// public void OnDataContextChanged() [instance] :4159
...
// public Fuse.Visual get_Parent() [instance] :3902
::g::Fuse::Visual* Node::Parent()
{
    return _parent;
}

// public Fuse.Properties get_Properties() [instance] :3892
...
// public bool Remove(Fuse.Binding item) [instance] :4040
...
// private void Root(Fuse.Binding b) [instance] :3991
...
// private void RootBindings() [instance] :4001
...
// internal generated void add_RootingCompleted(Uno.Action value) [instance] :4483
...
// internal generated void remove_RootingCompleted(Uno.Action value) [instance] :4483
...
// internal void RootInternal(Fuse.Visual parent) [instance] :4436
...
// private void RootInternalImpl(Fuse.Visual parent) [instance] :4449
...
// private void Unroot(Fuse.Binding b) [instance] :3996
...
// private void UnrootBindings() [instance] :4013
...
// internal generated void add_Unrooted(Uno.Action value) [instance] :4493
...
// internal generated void remove_Unrooted(Uno.Action value) [instance] :4493
...
// internal void UnrootInternal() [instance] :4495
...
// private static void _findData(Fuse.Scripting.Context c, Fuse.Node n, object[] args) [static] :4225
...
// internal static bool CaptureRooting() [static] :4413
...
// internal static bool IsRootCapture(int index) [static] :4408
...
// internal static void Relate(Fuse.Visual parent, Fuse.Node child) [static] :4523
...
// internal static void ReleaseRooting(bool captured) [static] :4426
...
// private static object TryFindData(object obj, string key) [static] :4264
...
// internal static void Unrelate(Fuse.Visual parent, Fuse.Node child) [static] :4531
...
// internal static int get_RootCaptureIndex() [static] :4407
...
// public sealed class OrthographicFrustum :8026
// {
...
// public generated OrthographicFrustum() :8026
void OrthographicFrustum__ctor__fn(OrthographicFrustum* __this)
{
    __this->ctor_();
}

// public float4x4 GetProjectionTransform(Fuse.ICommonViewport viewport) :8067
...
// public float4x4 GetProjectionTransformInverse(Fuse.ICommonViewport viewport) :8080
...
// public float4x4 GetViewTransform(Fuse.ICommonViewport viewport) :8072
...
// public float4x4 GetViewTransformInverse(Fuse.ICommonViewport viewport) :8085
...
// public float3 GetWorldPosition(Fuse.ICommonViewport viewport) :8093
...
// public float4x4 get_LocalFromWorld() :8059
...
// public void set_LocalFromWorld(float4x4 value) :8060
...
// private float4x4 MatrixProjection(float2 viewSize) :8117
...
// private float4x4 MatrixProjectionInverse(float2 viewSize) :8122
...
// private float4x4 MatrixView(float2 origin, float2 viewSize) :8103
...
// private float4x4 MatrixViewInverse(float2 origin, float2 viewSize) :8110
...
// public float4x4 GetProjectionTransformInverse(Fuse.ICommonViewport viewport) [instance] :8080
...
// public float4x4 GetViewTransform(Fuse.ICommonViewport viewport) [instance] :8072
...
// public float4x4 GetViewTransformInverse(Fuse.ICommonViewport viewport) [instance] :8085
...
// public float3 GetWorldPosition(Fuse.ICommonViewport viewport) [instance] :8093
...
// public float4x4 get_LocalFromWorld() [instance] :8059
::g::Uno::Float4x4 OrthographicFrustum::LocalFromWorld()
{
    return _localFromWorld;
}

// public void set_LocalFromWorld(float4x4 value) [instance] :8060
...
// private float4x4 MatrixProjection(float2 viewSize) [instance] :8117
...
// private float4x4 MatrixProjectionInverse(float2 viewSize) [instance] :8122
...
// private float4x4 MatrixView(float2 origin, float2 viewSize) [instance] :8103
...
// private float4x4 MatrixViewInverse(float2 origin, float2 viewSize) [instance] :8110
...
// public float2 get_Origin() [instance] :8032
::g::Uno::Float2 OrthographicFrustum::Origin()
{
    return _origin;
}

// public void set_Origin(float2 value) [instance] :8033
...
// public float2 get_Size() [instance] :8044
::g::Uno::Float2 OrthographicFrustum::Size()
{
    return _size;
}

// public void set_Size(float2 value) [instance] :8048
...
// public generated OrthographicFrustum New() [static] :8026
...
// /usr/local/share/uno/Packages/Fuse.iOS/0.39.3/$.uno
// ---------------------------------------------------
...
// private sealed class Visual.ParameterProperty :7035
// {
// static ParameterProperty() :7035
...
// public ParameterProperty New(Fuse.Visual visual) :7043
...
// public override sealed Uno.UX.PropertyObject get_Object() :7038
...
// public override sealed void Set(string value, Uno.UX.IPropertyListener origin) :7041
...
// public override sealed bool get_SupportsOriginSetter() :7039
...
// public ParameterProperty(Fuse.Visual visual) [instance] :7043
...
// public ParameterProperty New(Fuse.Visual visual) [static] :7043
...
// private sealed class TranslationModes.ParentSizeMode :10093
// {
...
// public generated ParentSizeMode() :10093
void TranslationModes__ParentSizeMode__ctor__fn(TranslationModes__ParentSizeMode* __this)
{
    __this->ctor_();
}

// public float3 GetAbsVector(Fuse.Translation t) :10095
...
// public generated ParentSizeMode New() :10093
...
// public object Subscribe(Fuse.ITransformRelative transform) :10096
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) :10103
...
// public generated ParentSizeMode() [instance] :10093
void TranslationModes__ParentSizeMode::ctor_()
{
}

// public float3 GetAbsVector(Fuse.Translation t) [instance] :10095
...
// public object Subscribe(Fuse.ITransformRelative transform) [instance] :10096
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :10103
...
// public generated ParentSizeMode New() [static] :10093
...
// public sealed class PendingRemoveVisual :4839
// {
...
// internal PendingRemoveVisual(Fuse.Visual child, Fuse.Visual parent, Uno.Action then) :4846
...
// public void AddSubscriber() [instance] :4854
void PendingRemoveVisual::AddSubscriber()
{
    subscribers++;
}

// public generated Fuse.Visual get_Child() [instance] :4842
::g::Fuse::Visual* PendingRemoveVisual::Child()
{
    return _Child;
}

// private generated void set_Child(Fuse.Visual value) [instance] :4842
void PendingRemoveVisual::Child(::g::Fuse::Visual* value)
{
    _Child = value;
}

// public bool get_HasSubscribers() [instance] :4870
bool PendingRemoveVisual::HasSubscribers()
{
    return subscribers > 0;
}

// public generated Fuse.Visual get_Parent() [instance] :4841
::g::Fuse::Visual* PendingRemoveVisual::Parent()
{
    return _Parent;
}

// private generated void set_Parent(Fuse.Visual value) [instance] :4841
void PendingRemoveVisual::Parent(::g::Fuse::Visual* value)
{
    _Parent = value;
}

// public void Remove() [instance] :4874
...
// public void RemoveSubscriber() [instance] :4859
...
// internal PendingRemoveVisual New(Fuse.Visual child, Fuse.Visual parent, Uno.Action then) [static] :4846
...
// public sealed class PlacedArgs :10023
// {
static void PlacedArgs_build(uType* type)
{
    ::STRINGS[37] = uString::Const("x");
    ::STRINGS[50] = uString::Const("y");
    ::STRINGS[51] = uString::Const("width");
    ::STRINGS[52] = uString::Const("height");
...
// internal PlacedArgs(bool hasPrev, float2 prevPosition, float2 newPosition, float2 prevSize, float2 newSize) :10031
...
// public generated bool get_HasPrev() :10025
void PlacedArgs__get_HasPrev_fn(PlacedArgs* __this, bool* __retval)
{
    *__retval = __this->HasPrev();
}

// private generated void set_HasPrev(bool value) :10025
void PlacedArgs__set_HasPrev_fn(PlacedArgs* __this, bool* value)
{
    __this->HasPrev(*value);
}

// internal PlacedArgs New(bool hasPrev, float2 prevPosition, float2 newPosition, float2 prevSize, float2 newSize) :10031
...
// public generated bool get_HasPrev() [instance] :10025
bool PlacedArgs::HasPrev()
{
    return _HasPrev;
}

// private generated void set_HasPrev(bool value) [instance] :10025
void PlacedArgs::HasPrev(bool value)
{
    _HasPrev = value;
}

// public generated float2 get_NewPosition() [instance] :10029
::g::Uno::Float2 PlacedArgs::NewPosition()
{
    return _NewPosition;
}

// private generated void set_NewPosition(float2 value) [instance] :10029
void PlacedArgs::NewPosition(::g::Uno::Float2 value)
{
    _NewPosition = value;
}

// public generated float2 get_NewSize() [instance] :10028
::g::Uno::Float2 PlacedArgs::NewSize()
{
    return _NewSize;
}

// private generated void set_NewSize(float2 value) [instance] :10028
void PlacedArgs::NewSize(::g::Uno::Float2 value)
{
    _NewSize = value;
}

// public generated float2 get_PrevPosition() [instance] :10026
::g::Uno::Float2 PlacedArgs::PrevPosition()
{
    return _PrevPosition;
}

// private generated void set_PrevPosition(float2 value) [instance] :10026
void PlacedArgs::PrevPosition(::g::Uno::Float2 value)
{
    _PrevPosition = value;
}

// public generated float2 get_PrevSize() [instance] :10027
::g::Uno::Float2 PlacedArgs::PrevSize()
{
    return _PrevSize;
}

// private generated void set_PrevSize(float2 value) [instance] :10027
void PlacedArgs::PrevSize(::g::Uno::Float2 value)
{
    _PrevSize = value;
}

// public void Serialize(Fuse.Scripting.IEventSerializer serializer) [instance] :10041
void PlacedArgs::Serialize(uObject* serializer)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[58/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[50/*"y"*/], (double)NewPosition().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[58/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[51/*"width"*/], (double)NewSize().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[58/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[52/*"height"*/], (double)NewSize().Y);
}

// internal PlacedArgs New(bool hasPrev, float2 prevPosition, float2 newPosition, float2 prevSize, float2 newSize) [static] :10031
...
// public delegate void PlacedHandler(object sender, Fuse.PlacedArgs args) :10054
...
// public sealed class Properties :8634
// {
// static Properties() :8634
...
// public static Fuse.PropertyHandle CreateHandle() :8640
void Properties__CreateHandle_fn(::g::Fuse::PropertyHandle** __retval)
{
    *__retval = Properties::CreateHandle();
}

// public void ForeachInList(Fuse.PropertyHandle handle, Uno.Action<object, object[]> action, object[] state) :8751
...
// public void ForeachInList(Fuse.PropertyHandle handle, Uno.Action<object, object> action, object state) :8734
...
// public void Set(Fuse.PropertyHandle handle, object val) :8667
void Properties__Set_fn(Properties* __this, ::g::Fuse::PropertyHandle* handle, uObject* val)
{
    __this->Set(handle, val);
}

// public bool TryGet(Fuse.PropertyHandle handle, object& val) :8652
...
// public generated Properties() [instance] :8634
void Properties::ctor_()
{
}

// public void AddToList(Fuse.PropertyHandle handle, object val) [instance] :8685
...
// public void Clear(Fuse.PropertyHandle handle) [instance] :8768
void Properties::Clear(::g::Fuse::PropertyHandle* handle)
{
    Clear1(handle, Properties::NoValue(), true);
}

// private void Clear(Fuse.PropertyHandle handle, object val, bool all) [instance] :8775
...
// public void ForeachInList(Fuse.PropertyHandle handle, Uno.Action<object, object[]> action, object[] state) [instance] :8751
...
// public void ForeachInList(Fuse.PropertyHandle handle, Uno.Action<object, object> action, object state) [instance] :8734
...
// public object Get(Fuse.PropertyHandle handle) [instance] :8645
...
// public void RemoveFromList(Fuse.PropertyHandle handle, object val) [instance] :8703
void Properties::RemoveFromList(::g::Fuse::PropertyHandle* handle, uObject* val)
{
    Clear1(handle, val, false);
}

// public void Set(Fuse.PropertyHandle handle, object val) [instance] :8667
...
// public bool TryGet(Fuse.PropertyHandle handle, object& val) [instance] :8652
...
// public static Fuse.PropertyHandle CreateHandle() [static] :8640
...
// public generated Properties New() [static] :8634
...
// public sealed class PropertyHandle :8629
// {
...
// public abstract class RelativeTransform<TransformMode> :9898
// {
...
// private Fuse.Visual Fuse.ITransformRelative.get_RelativeNode() :9936
...
// protected override sealed void OnRooted() :9939
...
// private void CheckSubscription(bool fromRooted) [instance] :9977
...
// private void ClearRootingCompleted() [instance] :9963
...
// private void ClearSubscription() [instance] :9952
...
// private void OnRootingCompleted() [instance] :9971
void RelativeTransform::OnRootingCompleted()
{
    CheckSubscription(false);
}

// public Fuse.Visual get_RelativeNode() [instance] :9904
...
// public void set_RelativeNode(Fuse.Visual value) [instance] :9905
...
// public TransformMode get_RelativeTo() [instance] :9918
uObject* RelativeTransform::RelativeTo()
{
    return _relativeTo;
}

// public void set_RelativeTo(TransformMode value) [instance] :9919
...
// public sealed class RequestBringIntoViewArgs :6340
// {
...
// public RequestBringIntoViewArgs(Fuse.Visual elm) :6343
void RequestBringIntoViewArgs__ctor_1_fn(RequestBringIntoViewArgs* __this, ::g::Fuse::Visual* elm)
{
    __this->ctor_1(elm);
}

// public RequestBringIntoViewArgs New(Fuse.Visual elm) :6343
...
// public generated Fuse.Visual get_Visual() :6342
...
// private generated void set_Visual(Fuse.Visual value) :6342
void RequestBringIntoViewArgs__set_Visual_fn(RequestBringIntoViewArgs* __this, ::g::Fuse::Visual* value)
{
    __this->Visual(value);
}

// public RequestBringIntoViewArgs(Fuse.Visual elm) [instance] :6343
...
// public generated Fuse.Visual get_Visual() [instance] :6342
::g::Fuse::Visual* RequestBringIntoViewArgs::Visual()
{
    return _Visual;
}

// private generated void set_Visual(Fuse.Visual value) [instance] :6342
void RequestBringIntoViewArgs::Visual(::g::Fuse::Visual* value)
{
    _Visual = value;
}

// public RequestBringIntoViewArgs New(Fuse.Visual elm) [static] :6343
...
// public delegate void RequestBringIntoViewHandler(object sender, Fuse.RequestBringIntoViewArgs args) :6349
...
// public sealed class RootViewport :8962
// {
static void RootViewport_build(uType* type)
{
    ...
    ::TYPES[32] = ::g::Uno::Exception_typeof();
    ::TYPES[62] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Float2_typeof());
    type->SetInterfaces(
...
// public RootViewport(Uno.Platform.Window window, [float overridePixelsPerPoint]) :8968
...
// public override sealed void Draw(Fuse.DrawContext dc) :8999
...
// public float4x4 get_ViewTransform() :9158
void RootViewport__get_ViewTransform_fn(RootViewport* __this, ::g::Uno::Float4x4* __retval)
{
    *__retval = __this->ViewTransform();
}

// public override sealed Fuse.VisualContext get_VisualContext() :8996
void RootViewport__get_VisualContext_fn(RootViewport* __this, int* __retval)
{
    return *__retval = 1, void();
}

// public Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) :9165
...
// public RootViewport(Uno.Platform.Window window, [float overridePixelsPerPoint]) [instance] :8968
...
// private void EstablishSize() [instance] :9051
...
// private extern void EstablishSizeInternals() [instance] :9113
...
// private void OnGotFocus(object sender, Uno.EventArgs args) [instance] :9008
...
// private void OnLostFocus(object sender, Uno.EventArgs args) [instance] :9020
...
// internal void OnResized(object s, object a) [instance] :9032
...
// public float2 get_PixelSize() [instance] :9144
::g::Uno::Float2 RootViewport::PixelSize()
{
    return _pixelSize;
}

// public float get_PixelsPerPoint() [instance] :9131
float RootViewport::PixelsPerPoint()
{
    return (_overridePixelsPerPoint > 0.0f) ? _overridePixelsPerPoint : _pixelsPerPoint;
}

// public Uno.Geometry.Ray PointToWorldRay(float2 pixelPos) [instance] :9161
...
// public generated void add_Resized(Uno.Action<float2> value) [instance] :8966
...
// public generated void remove_Resized(Uno.Action<float2> value) [instance] :8966
...
// public float2 get_Size() [instance] :9138
::g::Uno::Float2 RootViewport::Size()
{
    return ::g::Uno::Float2__op_Division1(PixelSize(), PixelsPerPoint());
}

// public float4x4 get_ViewTransform() [instance] :9158
::g::Uno::Float4x4 RootViewport::ViewTransform()
{
    return uPtr(_frustumViewport)->ViewTransform;
}

// public Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) [instance] :9165
::g::Uno::Geometry::Ray RootViewport::WorldToLocalRay(uObject* world, ::g::Uno::Geometry::Ray worldRay, ::g::Fuse::Visual* where)
{
    return ::g::Fuse::FrustumViewport::WorldToLocalRay((uObject*)this, world, worldRay, where);
}

// public RootViewport New(Uno.Platform.Window window, [float overridePixelsPerPoint]) [static] :8968
...
// public sealed class Rotation :9659
// {
...
// public generated Rotation() :9659
void Rotation__ctor_3_fn(Rotation* __this)
{
    __this->ctor_3();
}

// public override sealed void AppendTo(Fuse.FastMatrix m, float weight) :9758
...
// public generated Rotation New() :9659
void Rotation__New2_fn(Rotation** __retval)
{
    *__retval = Rotation::New2();
}

// public override sealed void PrependTo(Fuse.FastMatrix m) :9764
...
// public generated Rotation() [instance] :9659
void Rotation::ctor_3()
{
    ctor_2();
}

// public float get_Degrees() [instance] :9697
float Rotation::Degrees()
{
    return DegreesZ();
}

// public void set_Degrees(float value) [instance] :9698
void Rotation::Degrees(float value)
{
    DegreesZ(value);
}

// public float get_DegreesZ() [instance] :9706
float Rotation::DegreesZ()
{
    return ::g::Uno::Math::RadiansToDegrees1(_euler.Z);
}

// public void set_DegreesZ(float value) [instance] :9707
...
// public float3 get_EulerAngle() [instance] :9665
::g::Uno::Float3 Rotation::EulerAngle()
{
    return _euler;
}

// public void set_EulerAngle(float3 value) [instance] :9666
...
// public sealed class Scaling :9218
// {
...
// public override sealed void AppendTo(Fuse.FastMatrix m, float weight) :9297
...
// private float3 get_EffectiveVector() [instance] :9284
...
// private bool IsIdentity(float3 v) [instance] :9290
...
// public float3 get_Vector() [instance] :9250
::g::Uno::Float3 Scaling::Vector()
{
    return _vector;
}

// public void set_Vector(float3 value) [instance] :9251
...
// public Scaling New() [static] :9220
...
// public static class ScalingModes :9186
// {
// static ScalingModes() :9186
...
// public sealed class Shear :9782
// {
...
// public generated Shear() :9782
void Shear__ctor_3_fn(Shear* __this)
{
    __this->ctor_3();
}

// public override sealed void AppendTo(Fuse.FastMatrix m, float weight) :9840
...
// public override sealed bool get_IsFlat() :9854
void Shear__get_IsFlat_fn(Shear* __this, bool* __retval)
{
    return *__retval = true, void();
}

// public generated Shear New() :9782
void Shear__New2_fn(Shear** __retval)
{
    *__retval = Shear::New2();
}

// public override sealed void PrependTo(Fuse.FastMatrix m) :9846
...
// public float2 get_Vector() :9788
void Shear__get_Vector_fn(Shear* __this, ::g::Uno::Float2* __retval)
{
    *__retval = __this->Vector();
}

// public void set_Vector(float2 value) :9789
void Shear__set_Vector_fn(Shear* __this, ::g::Uno::Float2* value)
{
    __this->Vector(*value);
}

// public generated Shear() [instance] :9782
void Shear::ctor_3()
{
    ctor_2();
}

// public float2 get_Vector() [instance] :9788
::g::Uno::Float2 Shear::Vector()
{
    return _vector;
}

// public void set_Vector(float2 value) [instance] :9789
...
// public generated Shear New() [static] :9782
Shear* Shear::New2()
{
...
// private class TranslationModes.SizeMode :10077
// {
...
// public generated SizeMode() :10077
void TranslationModes__SizeMode__ctor__fn(TranslationModes__SizeMode* __this)
{
    __this->ctor_();
}

// public virtual float3 GetAbsVector(Fuse.Translation t) :10079
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :10087
void TranslationModes__SizeMode::Unsubscribe(uObject* transform, uObject* sub)
{
    ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(uAs<uObject*>(sub, ::TYPES[55/*Fuse.IActualPlacement*/])), ::TYPES[55/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[57/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[56/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
}

// public generated SizeMode New() [static] :10077
...
// internal sealed class Stage :10334
// {
static void Stage_build(uType* type)
{
    ::TYPES[64] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateListener_typeof());
    ::TYPES[65] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateAction_typeof());
    type->SetFields(0,
...
// public void AddDeferredAction(Uno.Action pu, [int priority]) [instance] :10371
...
// public void Insert(Uno.Collections.List<Fuse.UpdateListener> list, Fuse.UpdateListener us) [instance] :10353
...
// public void ResetDeferredActions() [instance] :10382
...
// public Stage New(Fuse.UpdateStage _updateStage) [static] :10347
...
// internal static void Init(double start) [static] :9545
...
// internal static void Set(double current) [static] :9554
...
// public static double get_FrameInterval() [static] :9579
double Time::FrameInterval()
{
    return Time::_delta_;
}

// public static double get_FrameTime() [static] :9572
double Time::FrameTime()
{
    return Time::_current_ - Time::_base_;
}

// public static double get_FrameTimeBase() [static] :9585
...
// public abstract class Transform :9622
// {
static void Transform_build(uType* type)
{
    ::TYPES[66] = ::g::Uno::Action1_typeof()->MakeType(Transform_typeof());
    type->SetInterfaces(
...
// internal Transform() :9642
void Transform__ctor_2_fn(Transform* __this)
{
    __this->ctor_2();
}

// internal generated void add_MatrixChanged(Uno.Action<Fuse.Transform> value) :9627
void Transform__add_MatrixChanged_fn(Transform* __this, uDelegate* value)
{
    __this->add_MatrixChanged(value);
}

// internal generated void remove_MatrixChanged(Uno.Action<Fuse.Transform> value) :9627
void Transform__remove_MatrixChanged_fn(Transform* __this, uDelegate* value)
{
    __this->remove_MatrixChanged(value);
}

// protected void OnMatrixChanged([object igoreSender], [object ignoreArgs]) :9629
...
// internal Transform() [instance] :9642
void Transform::ctor_2()
{
    ctor_1();
}

// internal generated void add_MatrixChanged(Uno.Action<Fuse.Transform> value) [instance] :9627
...
// internal generated void remove_MatrixChanged(Uno.Action<Fuse.Transform> value) [instance] :9627
...
// protected void OnMatrixChanged([object igoreSender], [object ignoreArgs]) [instance] :9629
...
// public sealed class Translation :10151
// {
...
// public Translation() :10153
void Translation__ctor_4_fn(Translation* __this)
{
    __this->ctor_4();
}

// public override sealed void AppendTo(Fuse.FastMatrix m, float weight) :10252
...
// public float get_X() [instance] :10165
float Translation::X()
{
    return _x;
}

// public void set_X(float value) [instance] :10166
...
// public float get_Y() [instance] :10203
float Translation::Y()
{
    return _y;
}

// public void set_Y(float value) [instance] :10204
...
// public float get_Z() [instance] :10222
float Translation::Z()
{
    return _z;
}

// public void set_Z(float value) [instance] :10223
...
// public Translation New() [static] :10153
...
// public static class TranslationModes :10068
// {
// static TranslationModes() :10068
...
// private static float3 SizeOf(Fuse.Node node) :10110
...
// private static float3 SizeOf(Fuse.Node node) [static] :10110
...
// internal sealed class UpdateDispatcher :10389
// {
...
// internal sealed class UpdateListener :10306
// {
...
// public generated UpdateListener New() [static] :10306
...
// public static class UpdateManager :10397
// {
// static UpdateManager() :10404
...
static void UpdateManager_build(uType* type)
{
    ...
    ::TYPES[69] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Stage_typeof());
    ::TYPES[70] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[71] = ::g::Uno::IDisposable_typeof();
    ::TYPES[32] = ::g::Uno::Exception_typeof();
    ::TYPES[72] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Exception_typeof());
    type->SetFields(0,
...
// public static void AddAction(Fuse.IUpdateListener pu, [Fuse.UpdateStage stage]) :10424
void UpdateManager__AddAction_fn(uObject* pu, int* stage)
{
    UpdateManager::AddAction(pu, *stage);
}

// public static void AddAction(Uno.Action pu, [Fuse.UpdateStage stage]) :10413
void UpdateManager__AddAction1_fn(uDelegate* pu, int* stage)
{
    UpdateManager::AddAction1(pu, *stage);
}

// public static void AddDeferredAction(Uno.Action pu, [Fuse.UpdateStage stage], [int priority]) :10515
...
// public static void Update() :10533
void UpdateManager__Update_fn()
{
    UpdateManager::Update();
}

// private static void Update(Fuse.Stage stage) :10573
...
// public static void AddAction(Fuse.IUpdateListener pu, [Fuse.UpdateStage stage]) [static] :10424
...
// public static void AddAction(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :10413
...
// public static void AddDeferredAction(Uno.Action pu, [Fuse.UpdateStage stage], [int priority]) [static] :10515
...
// public static void AddDeferredAction(Uno.Action pu, int priority) [static] :10522
...
// public static void AddOnceAction(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :10468
...
// private static void CheckExceptions(Uno.Collections.List<Uno.Exception> exs) [static] :10694
...
// public static void IncreaseFrameIndex() [static] :10527
...
// public static void PerformNextFrame(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :10485
...
// public static void PostAction(Uno.Action pu) [static] :10499
...
// private static void ProcessPostActions() [static] :10658
...
// public static void RemoveAction(Fuse.IUpdateListener pu, [Fuse.UpdateStage stage]) [static] :10460
...
// public static void RemoveAction(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :10452
...
// private static bool RemoveFrom(Uno.Collections.List<Fuse.UpdateListener> list, Uno.Action action, Fuse.IUpdateListener update) [static] :10434
...
// public static void Update() [static] :10533
...
// private static void Update(Fuse.Stage stage) [static] :10573
...
// public static int get_FrameIndex() [static] :10708
...
// /usr/local/share/uno/Packages/Fuse.UserEvents/0.39.3/$.uno
// ----------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(UserEvent_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[44/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[73/*Fuse.Scripting.ScriptMethod<Fuse.UserEvent>*/], ::STRINGS[54/*"raise"*/], uDelegate::New(::TYPES[74/*Uno.Action<Fuse.Scripting.Context, Fuse.UserEvent, object[]>*/], (void*)UserEvent__raise_fn), 2)));
}
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[56] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/0.39.3/$.uno");
    ...
    ::TYPES[43] = ::g::Uno::Type_typeof();
    ::TYPES[44] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[73] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(UserEvent_typeof());
    ::TYPES[74] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), UserEvent_typeof(), uObject_typeof()->Array());
...
static void UserEventArgs_build(uType* type)
{
    ...
    ::TYPES[58] = ::g::Fuse::Scripting::IEventSerializer_typeof();
    ::TYPES[77] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[78] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    type->SetInterfaces(
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[58/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[62/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->Dispatch())->Name()));
...
{
    ::TYPES[79] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), UserEventDispatch_typeof());
    ::TYPES[8] = ::g::Uno::Action_typeof();
...
// public interfacemodifiers class Visual :4890
// {
// static Visual() :7027
static void Visual__cctor_1_fn(uType* __type)
{
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(Visual_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[44/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptProperty1*)::g::Fuse::Scripting::ScriptProperty1::New1(::TYPES[83/*Fuse.Scripting.ScriptProperty<Fuse.Visual, string>*/], ::STRINGS[49/*"Parameter"*/], uDelegate::New(::TYPES[84/*Uno.Func<Fuse.Visual, Uno.UX.Property<string>>*/], (void*)Visual__getParameterProperty_fn), ::STRINGS[64/*".notNull()....*/]), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[85/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[65/*"onParameter...*/], uDelegate::New(::TYPES[86/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__onParameterChanged_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[85/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[66/*"bringIntoView"*/], uDelegate::New(::TYPES[86/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__bringIntoView_fn), 2)));
}
...
static void Visual_build(uType* type)
{
    ...
    ::TYPES[81] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[82] = ::g::Fuse::Node_typeof()->Array();
    ::TYPES[43] = ::g::Uno::Type_typeof();
    ::TYPES[44] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[83] = ::g::Fuse::Scripting::ScriptProperty1_typeof()->MakeType(Visual_typeof(), ::g::Uno::String_typeof());
    ::TYPES[84] = ::g::Uno::Func1_typeof()->MakeType(Visual_typeof(), ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof()));
    ::TYPES[85] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(Visual_typeof());
    ::TYPES[86] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), Visual_typeof(), uObject_typeof()->Array());
    ::TYPES[60] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[87] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::Function_typeof());
    ::TYPES[88] = ::g::Fuse::Scripting::IScriptObject_typeof();
    ::TYPES[10] = uObject_typeof()->Array();
    ::TYPES[89] = ::g::Fuse::IDataProvider_typeof();
    ::TYPES[61] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[90] = ::g::Uno::Int_typeof()->Array();
    ::TYPES[91] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof());
    ::TYPES[5] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(Visual_typeof());
    ::TYPES[92] = ::g::Fuse::Transform_typeof();
    ::TYPES[49] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    ::TYPES[93] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof());
    ::TYPES[94] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof());
    ::TYPES[95] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(uObject_typeof());
    ::TYPES[96] = ::g::Uno::Comparison_typeof()->MakeType(Visual_typeof());
    ::TYPES[97] = ::g::Fuse::FastProperty1Link1_typeof();
    ::TYPES[98] = ::g::Fuse::FastProperty2Link1_typeof();
    ::TYPES[99] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof());
    ::TYPES[100] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Template_typeof());
    ::TYPES[7] = ::g::Fuse::IViewport_typeof();
    ::TYPES[101] = ::g::Fuse::HitTestCallback_typeof();
    ::TYPES[102] = ::g::Uno::Collections::HashSet_typeof()->MakeType(Visual_typeof());
    ::TYPES[103] = ::g::Fuse::Node_typeof();
    ::TYPES[104] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[105] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[2] = ::g::Uno::EventHandler_typeof();
    ...
    ::TYPES[47] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[109] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    ::TYPES[110] = ::g::Fuse::ITemplateObserver_typeof();
    ::TYPES[66] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Transform_typeof());
    ::TYPES[23] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[111] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof());
    ::TYPES[112] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[113] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[8] = ::g::Uno::Action_typeof();
    ::TYPES[114] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[115] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[116] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[117] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Template_typeof());
    ::TYPES[118] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Template_typeof());
...
// private void AddParameterChangedListener(Fuse.Scripting.Function func) :6975
...
// internal void AdjustMarginBoxPosition(float2 position) :6730
void Visual__AdjustMarginBoxPosition_fn(Visual* __this, ::g::Uno::Float2* position)
{
    __this->AdjustMarginBoxPosition(*position);
}

// protected internal override sealed void AppendSubtreeData(Uno.Collections.List<object> result) :7587
...
// internal bool get_AreChildrenFlat() :6164
void Visual__get_AreChildrenFlat_fn(Visual* __this, bool* __retval)
{
    *__retval = __this->AreChildrenFlat();
}

// public float2 ArrangeMarginBox(float2 position, Fuse.LayoutParams lp) :6697
...
// internal Fuse.VisualBounds CalcRenderBoundsInParentSpace() :7409
...
// protected void DrawLocalSelectionRect(Fuse.DrawContext dc, Uno.Rect rect) :5364
...
// public virtual void DrawSelection(Fuse.DrawContext dc) :5374
...
// internal T Get<T>(Fuse.FastProperty2 p, T defaultValue) :5668
...
// public Fuse.Visual GetHitWindowPoint(float2 windowPoint) :5835
...
// public virtual float2 GetMarginSize(Fuse.LayoutParams lp) :6401
void Visual__GetMarginSize_fn(Visual* __this, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    return *__retval = ::g::Uno::Float2__New1(0.0f), void();
}

// public T GetNearestAncestorOfType<T>() :7674
...
// protected virtual Fuse.VisualBounds get_HitTestChildrenBounds() :5900
...
// protected virtual Fuse.VisualBounds get_HitTestLocalBounds() :5892
...
// private void Insert<T>(Fuse.FastProperty2 p, T value) :5719
...
// protected virtual void OnChildRemoved(Fuse.Node elm) :5060
...
// protected virtual void OnHitTest(Fuse.HitTestContext htc) :5825
...
// internal virtual Fuse.FastMatrix get_ParentWorldTransformInternal() :7244
...
// internal void Set<T>(Fuse.FastProperty2 p, T value, T defaultValue) :5674
...
// private void Uno.Collections.ICollection<Fuse.Node>.Clear() :5131
...
// private bool Uno.Collections.ICollection<Fuse.Node>.Contains(Fuse.Node item) :5174
...
// private int Uno.Collections.ICollection<Fuse.Node>.get_Count() :5184
...
// private Uno.Collections.IEnumerator<Fuse.Node> Uno.Collections.IEnumerable<Fuse.Node>.GetEnumerator() :5293
void Visual__UnoCollectionsIEnumerableFuseNodeGetEnumerator_fn(Visual* __this, uObject** __retval)
{
    ...
    return *__retval = uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[103/*Fuse.Node*/]), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->NodeList()), &ret51), ret51)), void();
}

// private Fuse.Node Uno.Collections.IList<Fuse.Node>.get_Item(int index) :5274
...
// private void Uno.Collections.IList<Fuse.Node>.RemoveAt(int index) :5253
...
// public virtual Fuse.VisualContext get_VisualContext() :7539
...
// public float2 WindowToLocal(float2 windowCoord) :7359
...
// protected generated Visual() [instance] :4890
void Visual::ctor_2()
{
...
// private bool get__areChildrenFlat() [instance] :6157
bool Visual::_areChildrenFlat()
{
    return HasBit(32);
}

// private void set__areChildrenFlat(bool value) [instance] :6158
void Visual::_areChildrenFlat(bool value)
{
    SetBit1(32, value);
}

// private bool get__areChildrenFlatCached() [instance] :6151
bool Visual::_areChildrenFlatCached()
{
    return HasBit(16);
}

// private void set__areChildrenFlatCached(bool value) [instance] :6152
void Visual::_areChildrenFlatCached(bool value)
{
    SetBit1(16, value);
}

// private bool get__isLocalFlat() [instance] :6121
bool Visual::_isLocalFlat()
{
    return HasBit(4);
}

// private void set__isLocalFlat(bool value) [instance] :6122
void Visual::_isLocalFlat(bool value)
{
    SetBit1(4, value);
}

// private bool get__isLocalFlatCached() [instance] :6116
bool Visual::_isLocalFlatCached()
{
    return HasBit(8);
}

// private void set__isLocalFlatCached(bool value) [instance] :6117
void Visual::_isLocalFlatCached(bool value)
{
    SetBit1(8, value);
}

// public float get_AbsoluteZoom() [instance] :6556
...
// public void Add(Fuse.Node item) [instance] :5147
...
// public void AddDrawCost(double cost) [instance] :7567
...
// private void AddEventHandler(Fuse.PropertyHandle ph, Fuse.Visual.VisualBits ne, object handler) [instance] :5425
...
// private void AddParameterChangedListener(Fuse.Scripting.Function func) [instance] :6975
void Visual::AddParameterChangedListener(::g::Fuse::Scripting::Function* func)
{
    ...
    if (::g::Uno::String::op_Inequality(_parameter, NULL))
    {
        ...
        if (so != NULL)
            uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[10/*object[]*/], 1, (uObject*)uPtr(::g::Fuse::Scripting::IScriptObject::ScriptContext(uInterface(uPtr(so), ::TYPES[88/*Fuse.Scripting.IScriptObject*/])))->ParseJson(_parameter)));
    }
}

// internal void AdjustMarginBoxPosition(float2 position) [instance] :6730
void Visual::AdjustMarginBoxPosition(::g::Uno::Float2 position)
{
    ArrangeMarginBox(position, _ambLayoutParams);
}

// internal bool get_AreChildrenFlat() [instance] :6164
...
// public float2 ArrangeMarginBox(float2 position, Fuse.LayoutParams lp) [instance] :6697
...
// public void BeginInteraction(object id, Uno.Action cancelled) [instance] :5942
...
// public void BeginRemoveChild(Fuse.Node n, [Uno.Action then]) [instance] :4926
...
// public void BeginRemoveVisual(Fuse.Visual child, [Uno.Action then]) [instance] :4893
...
// public void BringIntoView() [instance] :6766
void Visual::BringIntoView()
{
    OnBringIntoView(this);
}

// public void BringToFront(Fuse.Visual item) [instance] :7871
...
// internal bool CalcAreChildrenFlat() [instance] :6175
...
// internal Fuse.VisualBounds CalcRenderBoundsInParentSpace() [instance] :7409
...
// private Fuse.FastMatrix CalcWorldTransform() [instance] :7285
...
// public void CancelInteractions([Fuse.Visual.CancelInteractionsType how]) [instance] :5974
...
// internal void CancelPendingRemove() [instance] :4948
...
// public Uno.Collections.IList<Fuse.Node> get_Children() [instance] :5039
uObject* Visual::Children()
{
    return (uObject*)this;
}

// private void Clear(Fuse.FastProperty1 p) [instance] :5535
...
// private void Clear(Fuse.FastProperty2 p) [instance] :5687
...
// internal void ClearBit(Fuse.FastProperty1 p) [instance] :5551
void Visual::ClearBit(int p)
{
    _fastPropertyBits1 = (_fastPropertyBits1 & ~p);
}

// internal void ClearBit(Fuse.FastProperty2 p) [instance] :5703
void Visual::ClearBit1(int p)
{
    _fastPropertyBits2 = (_fastPropertyBits2 ^ p);
}

// private void ClearBit(Fuse.Visual.VisualBits nb) [instance] :5412
void Visual::ClearBit2(int nb)
{
    _nodebits = (_nodebits & ~(1 << nb));
}

// internal void ConcludePendingRemove() [instance] :4956
...
// public double get_DrawCost() [instance] :7565
double Visual::DrawCost()
{
    return _drawCost;
}

// private void DrawLocalRect(Fuse.DrawContext dc, Uno.Rect rect, float lineWidth, float4 color, float4x4 localToClipTransform) [instance] :5359
...
// protected void DrawLocalSelectionRect(Fuse.DrawContext dc, Uno.Rect rect) [instance] :5364
...
// private void EmitZOrderChanged() [instance] :7999
...
// public void EndInteraction(object id) [instance] :5951
...
// internal void EnsureSortedZOrder() [instance] :7948
...
// private void EnsureZOrder() [instance] :7964
...
// private Fuse.FastProperty1Link<T> Find<T>(Fuse.FastProperty1 p) [instance] :5598
...
// private Fuse.FastProperty2Link<T> Find<T>(Fuse.FastProperty2 p) [instance] :5750
...
// public T FindByType<T>() [instance] :7668
...
// private Fuse.FastProperty1Link FindPrevious(Fuse.FastProperty1 p) [instance] :5585
...
// private Fuse.FastProperty2Link FindPrevious(Fuse.FastProperty2 p) [instance] :5737
...
// public Uno.UX.Template FindTemplate(string key) [instance] :7477
...
// public Fuse.IViewport FindViewport() [instance] :7702
...
// public Fuse.Visual get_FirstVisualChild() [instance] :7796
Visual* Visual::FirstVisualChild()
{
    ...
    {
        Visual* c = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[61/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret56), ret56), Visual_typeof());
...
// public Fuse.Visual GetHitWindowPoint(float2 windowPoint) [instance] :5835
...
// public T GetNearestAncestorOfType<T>() [instance] :7674
...
// public float4x4 GetTransformTo(Fuse.Visual other) [instance] :7297
...
// private float4x4 GetTransformToAncestor(Fuse.Visual ancestor) [instance] :7326
...
// public Fuse.Visual GetZOrderChild(int index) [instance] :7850
...
// internal bool HasBit(Fuse.FastProperty1 p) [instance] :5546
bool Visual::HasBit(int p)
{
    return (_fastPropertyBits1 & p) != 0;
}

// internal bool HasBit(Fuse.FastProperty2 p) [instance] :5698
bool Visual::HasBit1(int p)
{
    return (_fastPropertyBits2 & p) != 0;
}

// private bool HasBit(Fuse.Visual.VisualBits nb) [instance] :5410
bool Visual::HasBit2(int nb)
{
    return (_nodebits & (1 << nb)) != 0;
}

// public bool get_HasChildren() [instance] :4992
...
// private bool get_HasExplicitTransforms() [instance] :7127
bool Visual::HasExplicitTransforms()
{
    return _transformCount > 0;
}

// internal bool get_HasMarginBox() [instance] :6675
bool Visual::HasMarginBox()
{
    return _hasMarginBox;
}

// public bool get_HasPendingRemove() [instance] :4965
bool Visual::HasPendingRemove()
{
    return HasBit(268435456);
}

// private bool get_HasResources() [instance] :6917
bool Visual::HasResources()
{
    return HasBit2(1);
}

// public bool get_HasVisualChildren() [instance] :7792
bool Visual::HasVisualChildren()
{
    return (_zOrder != NULL) && (uPtr(_zOrder)->Count() > 0);
}

// public void HitTest(Fuse.HitTestContext htc) [instance] :5793
...
// internal Fuse.Visual.HitTestTransformMode get_HitTestTransform() [instance] :5785
...
// private void InsertCleanup(Fuse.Node item) [instance] :5202
...
// private void InsertImpl(int index, Fuse.Node item) [instance] :5208
...
// internal void InsertNodes(int index, Uno.Collections.IEnumerator<Fuse.Node> items) [instance] :5224
...
// internal Fuse.FastMatrix get_InternLocalTransformInternal() [instance] :7256
::g::Fuse::FastMatrix* Visual::InternLocalTransformInternal()
{
    return LocalTransformInternal();
}

// internal float2 InternSnap(float2 p) [instance] :6516
::g::Uno::Float2 Visual::InternSnap(::g::Uno::Float2 p)
{
    return Snap(p);
}

// internal float2 InternSnapUp(float2 p) [instance] :6535
::g::Uno::Float2 Visual::InternSnapUp(::g::Uno::Float2 p)
{
    return SnapUp(p);
}

// internal void InvalidateFlat() [instance] :6103
...
// protected void InvalidateHitTestBounds() [instance] :5856
...
// public void InvalidateLayout([Fuse.InvalidateLayoutReason reason]) [instance] :6429
...
// protected void InvalidateRenderBounds() [instance] :7388
...
// public void InvalidateVisual() [instance] :7737
...
// public void InvalidateVisualComposition() [instance] :7757
...
// private void InvalidateWorldTransform() [instance] :7173
...
// private void InvalidateZOrder() [instance] :8005
...
// private void InvokeEventHandler(object obj, object args) [instance] :5419
void Visual::InvokeEventHandler(uObject* obj, uObject* args)
{
    uPtr(uCast<uDelegate*>(obj, ::TYPES[2/*Uno.EventHandler*/]))->Invoke(2, this, uCast< ::g::Uno::EventArgs*>(args, ::TYPES[106/*Uno.EventArgs*/]));
}

// public bool get_IsContextEnabled() [instance] :6065
bool Visual::IsContextEnabled()
{
    return HasBit(2);
}

// public void add_IsContextEnabledChanged(Uno.EventHandler value) [instance] :6022
void Visual::add_IsContextEnabledChanged(uDelegate* value)
{
    AddEventHandler(Visual::_isContextEnabledChangedHandle(), 4, value);
}

// public void remove_IsContextEnabledChanged(Uno.EventHandler value) [instance] :6023
...
// public bool get_IsEnabled() [instance] :6038
bool Visual::IsEnabled()
{
    return HasBit(1);
}

// public void set_IsEnabled(bool value) [instance] :6039
...
// public generated void add_IsInteractingChanged(Uno.EventHandler value) [instance] :5932
...
// public generated void remove_IsInteractingChanged(Uno.EventHandler value) [instance] :5932
...
// internal bool get_IsLocalFlat() [instance] :6128
...
// public bool get_IsVisible() [instance] :6221
...
// public void set_Layer(Fuse.Layer value) [instance] :6367
...
// public Fuse.LayoutRole get_LayoutRole() [instance] :6382
...
// public void set_LayoutRole(Fuse.LayoutRole value) [instance] :6394
...
// public float4x4 get_LocalTransform() [instance] :7250
::g::Uno::Float4x4 Visual::LocalTransform()
{
    return uPtr(LocalTransformInternal())->Matrix();
}

// protected Fuse.FastMatrix get_LocalTransformInternal() [instance] :7260
...
// protected float4x4 get_LocalTransformInverse() [instance] :7274
...
// private void MakeNodeList(Fuse.Node newItem) [instance] :5081
...
// internal float2 get_MarginBoxPosition() [instance] :6728
::g::Uno::Float2 Visual::MarginBoxPosition()
{
    return _ambPosition;
}

// private Fuse.Node get_Node() [instance] :5078
::g::Fuse::Node* Visual::Node()
{
    return uAs< ::g::Fuse::Node*>(_children, ::TYPES[103/*Fuse.Node*/]);
}

// private Uno.Collections.List<Fuse.Node> get_NodeList() [instance] :5079
...
// private void OnAdded(Fuse.Node b) [instance] :5090
...
// protected void OnBeginRemoveVisual(Fuse.PendingRemoveVisual args) [instance] :4937
...
// protected internal void OnBringIntoView(Fuse.Visual elm) [instance] :6757
...
// private void OnInteractionsChanged() [instance] :5963
...
// private void OnInvalidateChildZOffset(Fuse.Visual child) [instance] :7973
void Visual::OnInvalidateChildZOffset(Visual* child)
{
    SoftInvalidateZOrder(false);
}

// protected void OnIsContextEnabledChanged() [instance] :6082
...
// private void OnIsEnabledChanged(Uno.UX.IPropertyListener origin) [instance] :6050
void Visual::OnIsEnabledChanged(uObject* origin)
{
    OnPropertyChanged1(Visual::_isEnabledName(), origin);
}

// protected void OnLocalVisibleChanged() [instance] :6230
void Visual::OnLocalVisibleChanged()
{
    UpdateIsVisibleCache();
}

// private void OnMatrixChanged(Fuse.Transform t) [instance] :7159
void Visual::OnMatrixChanged(::g::Fuse::Transform* t)
{
    InvalidateLocalTransform();
}

// private void OnParameterChanged() [instance] :6992
...
// private void OnRemoved(Fuse.Node b) [instance] :5102
...
// private void OnTemplatesChanged(Uno.UX.Template t) [instance] :7465
...
// private void OnTransformAdded(Fuse.Transform t) [instance] :7145
...
// private void OnTransformRemoved(Fuse.Transform t) [instance] :7152
...
// private void OnVisualAdded(Fuse.Visual v) [instance] :5114
...
// private void OnVisualRemoved(Fuse.Visual v) [instance] :5122
...
// public string get_Parameter() [instance] :6962
uString* Visual::Parameter()
{
    return _parameter;
}

// public void set_Parameter(string value) [instance] :6963
...
// public float2 ParentToLocal(float2 parentPoint) [instance] :7688
...
// protected void PerformLayout() [instance] :6604
...
// protected void PerformLayout(float2 clientSize) [instance] :6612
...
// private void PrependExplicitTransforms(Fuse.FastMatrix m) [instance] :7345
...
// private void PrependLocalTransform(Fuse.FastMatrix m) [instance] :7339
...
// private void RaiseEvent(Fuse.PropertyHandle ph, Fuse.Visual.VisualBits ne) [instance] :5414
...
// private void RearrangeMarginBox() [instance] :6677
...
// public bool Remove(Fuse.Node item) [instance] :5152
...
// public void RemoveAllChildren<T>() [instance] :5020
...
// public void RemoveDrawCost(double cost) [instance] :7577
...
// private void RemoveEventHandler(Fuse.PropertyHandle ph, Fuse.Visual.VisualBits ne, object handler) [instance] :5431
...
// public generated void add_RequestBringIntoView(Fuse.RequestBringIntoViewHandler value) [instance] :6755
...
// public generated void remove_RequestBringIntoView(Fuse.RequestBringIntoViewHandler value) [instance] :6755
...
// private void ResetParameterListeners() [instance] :7007
void Visual::ResetParameterListeners()
{
    _parameterListeners = NULL;
}

// public Uno.Collections.IList<Uno.UX.Resource> get_Resources() [instance] :6865
uObject* Visual::Resources()
{
    if (!HasResources())
    {
        SetBit4(1);
        uPtr(Properties())->Set(Visual::_resourcesHandle(), (::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[115/*Uno.Collections.ObservableList<Uno.UX.Resource>*/], uDelegate::New(::TYPES[116/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this), uDelegate::New(::TYPES[116/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this)));
    }

    return (uObject*)uPtr(Properties())->Get(Visual::_resourcesHandle());
}

// public void SendToBack(Fuse.Visual item) [instance] :7892
...
// internal void SetBit(Fuse.FastProperty1 p) [instance] :5556
void Visual::SetBit(int p)
{
    _fastPropertyBits1 = (_fastPropertyBits1 | p);
}

// internal void SetBit(Fuse.FastProperty1 p, bool value) [instance] :5561
...
// internal void SetBit(Fuse.FastProperty2 p) [instance] :5708
void Visual::SetBit2(int p)
{
    _fastPropertyBits2 = (_fastPropertyBits2 | p);
}

// internal void SetBit(Fuse.FastProperty2 p, bool value) [instance] :5713
...
// private void SetBit(Fuse.Visual.VisualBits nb) [instance] :5411
void Visual::SetBit4(int nb)
{
    _nodebits = (_nodebits | (1 << nb));
}

// public void SetResource(string key, object value) [instance] :6876
...
// protected float2 Snap(float2 p) [instance] :6517
...
// protected float2 SnapDown(float2 p) [instance] :6542
...
// public bool get_SnapToPixels() [instance] :6570
bool Visual::SnapToPixels()
{
    return HasBit(67108864);
}

// public void set_SnapToPixels(bool value) [instance] :6574
...
// protected float2 SnapUp(float2 p) [instance] :6536
...
// private void SoftInvalidateZOrder([bool force]) [instance] :7983
...
// public Uno.Collections.IList<Uno.UX.Template> get_Templates() [instance] :7459
uObject* Visual::Templates()
{
    uObject* ind7 = _templates;
    return (ind7 != NULL) ? ind7 : (uObject*)(_templates = (uObject*)((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[117/*Uno.Collections.ObservableList<Uno.UX.Template>*/], uDelegate::New(::TYPES[118/*Uno.Action<Uno.UX.Template>*/], (void*)Visual__OnTemplatesChanged_fn, this), uDelegate::New(::TYPES[118/*Uno.Action<Uno.UX.Template>*/], (void*)Visual__OnTemplatesChanged_fn, this))));
}

// private void UpdateContextSnapToPixelsCache() [instance] :6586
...
// private void UpdateIsContextEnabledCache() [instance] :6068
...
// private void UpdateIsVisibleCache() [instance] :6235
...
// private void UpdateLayout() [instance] :6646
...
// public int get_ValidFrameCount() [instance] :7774
int Visual::ValidFrameCount()
{
    return ::g::Fuse::UpdateManager::FrameIndex() - _lastInvalidate;
}

// public Fuse.IViewport get_Viewport() [instance] :7718
...
// public float2 WindowToLocal(float2 windowCoord) [instance] :7359
...
// public float3 get_WorldPosition() [instance] :7223
...
// public float4x4 get_WorldTransform() [instance] :7215
::g::Uno::Float4x4 Visual::WorldTransform()
{
    return uPtr(WorldTransformInternal())->Matrix();
}

// private Fuse.FastMatrix get_WorldTransformInternal() [instance] :7234
...
// public float4x4 get_WorldTransformInverse() [instance] :7202
...
// public float get_ZOffset() [instance] :6785
float Visual::ZOffset()
{
    return _zOffset;
}

// public void set_ZOffset(float value) [instance] :6786
...
// internal Uno.Collections.List<Fuse.Visual> get_ZOrder() [instance] :7858
...
// internal generated void add_ZOrderChanged(Uno.EventHandler value) [instance] :7978
...
// internal generated void remove_ZOrderChanged(Uno.EventHandler value) [instance] :7978
...
// public int get_ZOrderChildCount() [instance] :7843
...
// private int ZOrderComparator(Fuse.Visual a, Fuse.Visual b) [instance] :7910
...
// private static void AssignZOrder(Uno.Collections.IList<Fuse.Node> nodes) [static] :7921
...
// private static void bringIntoView(Fuse.Scripting.Context c, Fuse.Visual n, object[] args) [static] :7059
...
// private static Uno.UX.Property<string> getParameterProperty(Fuse.Visual v) [static] :7047
...
// private static void onParameterChanged(Fuse.Scripting.Context c, Fuse.Visual v, object[] args) [static] :7085
...
// private enum Visual.VisualBits :5395
...
// public sealed class VisualBounds :4587
// {
// static VisualBounds() :4587
...
// private VisualBounds() :4589
void VisualBounds__ctor__fn(VisualBounds* __this)
{
    __this->ctor_();
}

// public Fuse.VisualBounds AddRect(float2 mn, float2 mx) :4670
...
// public Fuse.VisualBounds IntersectXY(Fuse.VisualBounds nb) :4755
...
// public Fuse.VisualBounds MergeChild(Fuse.Visual child, Fuse.VisualBounds nb) :4774
...
// private VisualBounds() [instance] :4589
void VisualBounds::ctor_()
{
}

// public Fuse.VisualBounds AddRect(float2 mn, float2 mx) [instance] :4670
...
// public Fuse.VisualBounds AddRect(Uno.Rect r) [instance] :4675
VisualBounds* VisualBounds::AddRect1(::g::Uno::Rect r)
{
    return AddRect(r.Minimum(), r.Maximum());
}

// public float3 get_AxisMax() [instance] :4647
::g::Uno::Float3 VisualBounds::AxisMax()
{
    return _box.Maximum;
}

// public float3 get_AxisMin() [instance] :4646
::g::Uno::Float3 VisualBounds::AxisMin()
{
    return _box.Minimum;
}

// public bool ContainsPoint(float2 pt) [instance] :4779
...
// public Uno.Rect get_FlatRect() [instance] :4652
...
// public Fuse.VisualBounds InflateXY(float padding) [instance] :4683
...
// public bool IntersectsRay(Uno.Geometry.Ray ray) [instance] :4791
...
// public Fuse.VisualBounds IntersectXY(Fuse.VisualBounds nb) [instance] :4755
...
// public bool get_IsEmpty() [instance] :4599
bool VisualBounds::IsEmpty()
{
    return this == VisualBounds::_empty();
}

// public bool get_IsFlat() [instance] :4657
bool VisualBounds::IsFlat()
{
    return IsEmpty() || ((_box.Minimum.Z == 0.0f) && (_box.Maximum.Z == 0.0f));
}

// public bool get_IsInfinite() [instance] :4610
bool VisualBounds::IsInfinite()
{
    return this == VisualBounds::_infinite();
}

// public Fuse.VisualBounds Merge(Fuse.VisualBounds nb, [Fuse.FastMatrix trans]) [instance] :4731
...
// public Fuse.VisualBounds MergeChild(Fuse.Visual child, Fuse.VisualBounds nb) [instance] :4774
...
// public float3 get_Size() [instance] :4648
::g::Uno::Float3 VisualBounds::Size()
{
    return ::g::Uno::Float3__op_Subtraction2(_box.Maximum, _box.Minimum);
}

// public Fuse.VisualBounds Translate(float3 offset) [instance] :4698
...
// public static Fuse.VisualBounds Box(Uno.Geometry.Box a) [static] :4637
...
// public static Uno.Geometry.Box BoxTransform(Uno.Geometry.Box box, float4x4 transform) [static] :4813
...
// private VisualBounds New() [static] :4589
...
// public static Fuse.VisualBounds Rect(float2 a, float2 b) [static] :4632
...
// public static Fuse.VisualBounds Rect(float3 a, float3 b) [static] :4624
...
// public static Fuse.VisualBounds get_Empty() [static] :4594
...
// public static Fuse.VisualBounds get_Infinite() [static] :4605
...
// public enum VisualContext :7503
...
{
    ::TYPES[120] = ::g::Uno::Collections::List_typeof();
    ::TYPES[32] = ::g::Uno::Exception_typeof();
    ::TYPES[6] = ::g::Fuse::Visual_typeof();
    ::TYPES[121] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof()->Array());
    ::TYPES[10] = uObject_typeof()->Array();
    type->SetPrecalc(
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = uDelegate::New(::TYPES[121/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaise_fn, this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = uDelegate::New(::TYPES[121/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaiseEnabled_fn, this);
            break;
        }
        default:
            return;
...
{
    ::STRINGS[70] = uString::Const("visual");
    type->SetInterfaces(
...
void VisualEventArgs::ctor_1(::g::Fuse::Visual* visual)
{
    ...
    if (visual == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[70/*"visual"*/]));
...
{
    VisualListCache::_visualListCache_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[122/*Uno.Collections.List<Uno.Collections.List<Fuse.Visual>>*/]));
}

static void VisualListCache_build(uType* type)
{
    ::TYPES[122] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof()));
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof());
    type->SetFields(0,
...
// private sealed class TranslationModes.WidthMode :10130
// {
...
// public generated WidthMode() :10130
void TranslationModes__WidthMode__ctor_1_fn(TranslationModes__WidthMode* __this)
{
    __this->ctor_1();
}

// public override sealed float3 GetAbsVector(Fuse.Translation t) :10132
...
// internal sealed class WrapException :10732
// {
static void WrapException_build(uType* type)
{
    ::STRINGS[71] = uString::Const("Wrapped Exception");
    type->SetFields(3);
}
...
// public WrapException(Uno.Exception inner) :10734
void WrapException__ctor_3_fn(WrapException* __this, ::g::Uno::Exception* inner)
{
    __this->ctor_3(inner);
}

// public override sealed string get_Message() :10758
...
// public static Uno.Exception Unwrap(Uno.Exception e) :10741
void WrapException__Unwrap_fn(::g::Uno::Exception* e, ::g::Uno::Exception** __retval)
{
    *__retval = WrapException::Unwrap(e);
}

// public WrapException(Uno.Exception inner) [instance] :10734
void WrapException::ctor_3(::g::Uno::Exception* inner)
{
    ctor_2(::STRINGS[71/*"Wrapped Exc...*/], inner);
}

// public WrapException New(Uno.Exception inner) [static] :10734
...
// public static Uno.Exception Unwrap(Uno.Exception e) [static] :10741
