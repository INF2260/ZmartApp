// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Primitives/0.39.3/textcontrols/$.uno.
...
{
    ::g::Fuse::Controls::Native::ITextEditHost interface14;
    ::g::Fuse::Input::INotifyFocus interface15;
};
